 ...
 */
export class ElbSource extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ElbSourceState, opts?: pulumi.CustomResourceOptions): ElbSource {
        return new ElbSource(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sumologic:index/elbSource:ElbSource';

    /**
     * Returns true if the given object is an instance of ElbSource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ElbSource {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ElbSource.__pulumiType;
    }

    public readonly authentication!: pulumi.Output<outputs.ElbSourceAuthentication>;
    ...
    public readonly defaultDateFormats!: pulumi.Output<outputs.ElbSourceDefaultDateFormat[] | undefined>;
    public readonly description!: pulumi.Output<string | undefined>;
    public readonly fields!: pulumi.Output<{[key: string]: string} | undefined>;
    public readonly filters!: pulumi.Output<outputs.ElbSourceFilter[] | undefined>;
    ...
    public readonly path!: pulumi.Output<outputs.ElbSourcePath>;
     ...
     */
    constructor(name: string, args: ElbSourceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ElbSourceArgs | ElbSourceState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ElbSourceState | undefined;
            ...
            const args = argsOrState as ElbSourceArgs | undefined;
        ...
        super(ElbSource.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface ElbSourceState {
    readonly authentication?: pulumi.Input<inputs.ElbSourceAuthentication>;
    ...
    readonly defaultDateFormats?: pulumi.Input<pulumi.Input<inputs.ElbSourceDefaultDateFormat>[]>;
    readonly description?: pulumi.Input<string>;
    readonly fields?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    readonly filters?: pulumi.Input<pulumi.Input<inputs.ElbSourceFilter>[]>;
    ...
    readonly path?: pulumi.Input<inputs.ElbSourcePath>;
 ...
 */
export interface ElbSourceArgs {
    readonly authentication: pulumi.Input<inputs.ElbSourceAuthentication>;
    readonly automaticDateParsing?: pulumi.Input<boolean>;
    readonly category?: pulumi.Input<string>;
    readonly collectorId: pulumi.Input<number>;
