 ...
 * ```
 */
export class RumSource extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RumSourceState, opts?: pulumi.CustomResourceOptions): RumSource {
        return new RumSource(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sumologic:index/rumSource:RumSource';

    /**
     * Returns true if the given object is an instance of RumSource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RumSource {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RumSource.__pulumiType;
    }
    ...
    public readonly defaultDateFormats!: pulumi.Output<outputs.RumSourceDefaultDateFormat[] | undefined>;
    public readonly description!: pulumi.Output<string | undefined>;
    public readonly fields!: pulumi.Output<{[key: string]: string} | undefined>;
    public readonly filters!: pulumi.Output<outputs.RumSourceFilter[] | undefined>;
    ...
    public readonly path!: pulumi.Output<outputs.RumSourcePath | undefined>;
     ...
     */
    constructor(name: string, args: RumSourceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RumSourceArgs | RumSourceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RumSourceState | undefined;
            ...
            const args = argsOrState as RumSourceArgs | undefined;
        ...
        super(RumSource.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RumSourceState {
    ...
    defaultDateFormats?: pulumi.Input<pulumi.Input<inputs.RumSourceDefaultDateFormat>[]>;
    description?: pulumi.Input<string>;
    fields?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    filters?: pulumi.Input<pulumi.Input<inputs.RumSourceFilter>[]>;
    ...
    path?: pulumi.Input<inputs.RumSourcePath>;
 ...
 */
export interface RumSourceArgs {
    automaticDateParsing?: pulumi.Input<boolean>;
    category?: pulumi.Input<string>;
    collectorId: pulumi.Input<number>;
    contentType?: pulumi.Input<string>;
