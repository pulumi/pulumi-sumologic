 ...
 * ```
 */
export class AzureEventHubLogSource extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AzureEventHubLogSourceState, opts?: pulumi.CustomResourceOptions): AzureEventHubLogSource {
        return new AzureEventHubLogSource(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sumologic:index/azureEventHubLogSource:AzureEventHubLogSource';

    /**
     * Returns true if the given object is an instance of AzureEventHubLogSource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AzureEventHubLogSource {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AzureEventHubLogSource.__pulumiType;
    }

    /**
     * Authentication details for connecting to Azure Event Hub.
     */
    public readonly authentication!: pulumi.Output<outputs.AzureEventHubLogSourceAuthentication>;
    ...
    public readonly defaultDateFormats!: pulumi.Output<outputs.AzureEventHubLogSourceDefaultDateFormat[] | undefined>;
    public readonly description!: pulumi.Output<string | undefined>;
    public readonly fields!: pulumi.Output<{[key: string]: string} | undefined>;
    public readonly filters!: pulumi.Output<outputs.AzureEventHubLogSourceFilter[] | undefined>;
     ...
     */
    public readonly path!: pulumi.Output<outputs.AzureEventHubLogSourcePath>;
     ...
     */
    constructor(name: string, args: AzureEventHubLogSourceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AzureEventHubLogSourceArgs | AzureEventHubLogSourceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AzureEventHubLogSourceState | undefined;
            ...
            const args = argsOrState as AzureEventHubLogSourceArgs | undefined;
        ...
        super(AzureEventHubLogSource.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AzureEventHubLogSourceState {
    /**
     * Authentication details for connecting to Azure Event Hub.
     */
    authentication?: pulumi.Input<inputs.AzureEventHubLogSourceAuthentication>;
    ...
    defaultDateFormats?: pulumi.Input<pulumi.Input<inputs.AzureEventHubLogSourceDefaultDateFormat>[]>;
    description?: pulumi.Input<string>;
    fields?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    filters?: pulumi.Input<pulumi.Input<inputs.AzureEventHubLogSourceFilter>[]>;
     ...
     * The location to scan for new data.
     */
    path?: pulumi.Input<inputs.AzureEventHubLogSourcePath>;
 ...
 */
export interface AzureEventHubLogSourceArgs {
    /**
     * Authentication details for connecting to Azure Event Hub.
     */
    authentication: pulumi.Input<inputs.AzureEventHubLogSourceAuthentication>;
