 ...
 *      + `bucketName` - (Required) The name of the bucket. This is needed if using type `S3BucketPathExpression`.
 *      + `pathExpression` - (Required) The path to the data. This is needed if using type `S3BucketPathExpression`.
 *
 * ## Import
 *
 ...
 */
export class CloudfrontSource extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudfrontSourceState, opts?: pulumi.CustomResourceOptions): CloudfrontSource {
        return new CloudfrontSource(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sumologic:index/cloudfrontSource:CloudfrontSource';

    /**
     * Returns true if the given object is an instance of CloudfrontSource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CloudfrontSource {
    ...
    public readonly defaultDateFormats!: pulumi.Output<outputs.CloudfrontSourceDefaultDateFormat[] | undefined>;
...
export interface CloudfrontSourceState {
    readonly authentication?: pulumi.Input<inputs.CloudfrontSourceAuthentication>;
    ...
    readonly defaultDateFormats?: pulumi.Input<pulumi.Input<inputs.CloudfrontSourceDefaultDateFormat>[]>;
    readonly description?: pulumi.Input<string>;
    readonly fields?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    readonly filters?: pulumi.Input<pulumi.Input<inputs.CloudfrontSourceFilter>[]>;
    ...
    readonly path?: pulumi.Input<inputs.CloudfrontSourcePath>;
