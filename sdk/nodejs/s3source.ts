...
export class S3Source extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: S3SourceArgs | S3SourceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(S3Source.__pulumiType, name, inputs, opts);
    }
}
...
export interface S3SourceState {
    readonly authentication?: pulumi.Input<inputs.S3SourceAuthentication>;
    ...
    readonly defaultDateFormats?: pulumi.Input<pulumi.Input<inputs.S3SourceDefaultDateFormat>[]>;
    readonly description?: pulumi.Input<string>;
    readonly fields?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    readonly filters?: pulumi.Input<pulumi.Input<inputs.S3SourceFilter>[]>;
    ...
    readonly path?: pulumi.Input<inputs.S3SourcePath>;
