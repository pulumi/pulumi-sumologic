...
func (o AwsXraySourceOutput) HashAlgorithm() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AwsXraySource) pulumi.StringPtrOutput { return v.HashAlgorithm }).(pulumi.StringPtrOutput)
}
