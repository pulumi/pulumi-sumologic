...
// When set to true, the scanner is paused. To disable, set to false.
func (o CloudtrailSourceOutput) Paused() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *CloudtrailSource) pulumi.BoolPtrOutput { return v.Paused }).(pulumi.BoolPtrOutput)
}

// Time interval in milliseconds of scans for new data. The default is 300000 and the minimum value is 1000 milliseconds.
func (o CloudtrailSourceOutput) ScanInterval() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *CloudtrailSource) pulumi.IntPtrOutput { return v.ScanInterval }).(pulumi.IntPtrOutput)
}
