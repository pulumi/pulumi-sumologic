...
//			_, err := sumologic.GetCallerIdentity(ctx, map[string]interface{}{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetCallerIdentityOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetCallerIdentityResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetCallerIdentityResultOutput, error) {
		...
		return ctx.InvokeOutput("sumologic:index/getCallerIdentity:getCallerIdentity", nil, GetCallerIdentityResultOutput{}, options).(GetCallerIdentityResultOutput), nil
