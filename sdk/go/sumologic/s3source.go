...
func (o S3SourceOutput) HashAlgorithm() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *S3Source) pulumi.StringPtrOutput { return v.HashAlgorithm }).(pulumi.StringPtrOutput)
}
