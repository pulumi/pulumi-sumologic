...
namespace Pulumi.SumoLogic.Outputs
{
    ...
    [OutputType]
    public sealed class MetricsSearchTimeRangeBeginBoundedTimeRangeToRelativeTimeRange
    {
        /// <summary>
        ...
        [OutputConstructor]
        private MetricsSearchTimeRangeBeginBoundedTimeRangeToRelativeTimeRange(string relativeTime)
        {
