...
namespace Pulumi.SumoLogic.Outputs
{
    ...
    [OutputType]
    public sealed class MetricsSearchV2TimeRangeBeginBoundedTimeRangeToRelativeTimeRange
    {
        /// <summary>
        ...
        [OutputConstructor]
        private MetricsSearchV2TimeRangeBeginBoundedTimeRangeToRelativeTimeRange(string relativeTime)
        {
