...
namespace Pulumi.SumoLogic.Outputs
{
    ...
    [OutputType]
    public sealed class MetricsSearchV2TimeRangeBeginBoundedTimeRangeFromRelativeTimeRange
    {
        /// <summary>
        ...
        [OutputConstructor]
        private MetricsSearchV2TimeRangeBeginBoundedTimeRangeFromRelativeTimeRange(string relativeTime)
        {
