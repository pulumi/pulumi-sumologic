...
namespace Pulumi.SumoLogic
{
    ...
    public partial class CloudwatchSource : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.CloudwatchSourceDefaultDateFormat>> DefaultDateFormats { get; private set; } = null!;
        ...
        [Output("filters")]
        public Output<ImmutableArray<Outputs.CloudwatchSourceFilter>> Filters { get; private set; } = null!;
        ...
        public CloudwatchSource(string name, CloudwatchSourceArgs args, CustomResourceOptions? options = null)
            : base("sumologic:index/cloudwatchSource:CloudwatchSource", name, args ?? new CloudwatchSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudwatchSource(string name, Input<string> id, CloudwatchSourceState? state = null, CustomResourceOptions? options = null)
            : base("sumologic:index/cloudwatchSource:CloudwatchSource", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CloudwatchSource Get(string name, Input<string> id, CloudwatchSourceState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class CloudwatchSourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.CloudwatchSourceDefaultDateFormatArgs>? _defaultDateFormats;
        public InputList<Inputs.CloudwatchSourceDefaultDateFormatArgs> DefaultDateFormats
        {
            get => _defaultDateFormats ?? (_defaultDateFormats = new InputList<Inputs.CloudwatchSourceDefaultDateFormatArgs>());
        ...
        [Input("filters")]
        private InputList<Inputs.CloudwatchSourceFilterArgs>? _filters;
        public InputList<Inputs.CloudwatchSourceFilterArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.CloudwatchSourceFilterArgs>());
            set => _filters = value;
        }
    ...
    public sealed class CloudwatchSourceState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("defaultDateFormats")]
        private InputList<Inputs.CloudwatchSourceDefaultDateFormatGetArgs>? _defaultDateFormats;
        public InputList<Inputs.CloudwatchSourceDefaultDateFormatGetArgs> DefaultDateFormats
        {
            get => _defaultDateFormats ?? (_defaultDateFormats = new InputList<Inputs.CloudwatchSourceDefaultDateFormatGetArgs>());
            set => _defaultDateFormats = value;
        }
        ...
        [Input("filters")]
        private InputList<Inputs.CloudwatchSourceFilterGetArgs>? _filters;
        public InputList<Inputs.CloudwatchSourceFilterGetArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.CloudwatchSourceFilterGetArgs>());
            set => _filters = value;
        }
