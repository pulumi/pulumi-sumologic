...
namespace Pulumi.SumoLogic
{
    ...
    public partial class ElbSource : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.ElbSourceAuthentication> Authentication { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.ElbSourceDefaultDateFormat>> DefaultDateFormats { get; private set; } = null!;
        ...
        [Output("filters")]
        public Output<ImmutableArray<Outputs.ElbSourceFilter>> Filters { get; private set; } = null!;
        ...
        /// </summary>
        [Output("path")]
        public Output<Outputs.ElbSourcePath> Path { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a ElbSource resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public ElbSource(string name, ElbSourceArgs args, CustomResourceOptions? options = null)
            : base("sumologic:index/elbSource:ElbSource", name, args ?? new ElbSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ElbSource(string name, Input<string> id, ElbSourceState? state = null, CustomResourceOptions? options = null)
            : base("sumologic:index/elbSource:ElbSource", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ElbSource Get(string name, Input<string> id, ElbSourceState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class ElbSourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ElbSourceAuthenticationArgs> Authentication { get; set; } = null!;
        ...
        private InputList<Inputs.ElbSourceDefaultDateFormatArgs>? _defaultDateFormats;
        public InputList<Inputs.ElbSourceDefaultDateFormatArgs> DefaultDateFormats
        {
            get => _defaultDateFormats ?? (_defaultDateFormats = new InputList<Inputs.ElbSourceDefaultDateFormatArgs>());
        ...
        [Input("filters")]
        private InputList<Inputs.ElbSourceFilterArgs>? _filters;
        public InputList<Inputs.ElbSourceFilterArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.ElbSourceFilterArgs>());
            set => _filters = value;
        }
        ...
        public Input<Inputs.ElbSourcePathArgs> Path { get; set; } = null!;
    ...
    public sealed class ElbSourceState : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ElbSourceAuthenticationGetArgs>? Authentication { get; set; }
        ...
        [Input("defaultDateFormats")]
        private InputList<Inputs.ElbSourceDefaultDateFormatGetArgs>? _defaultDateFormats;
        public InputList<Inputs.ElbSourceDefaultDateFormatGetArgs> DefaultDateFormats
        {
            get => _defaultDateFormats ?? (_defaultDateFormats = new InputList<Inputs.ElbSourceDefaultDateFormatGetArgs>());
            set => _defaultDateFormats = value;
        }
        ...
        [Input("filters")]
        private InputList<Inputs.ElbSourceFilterGetArgs>? _filters;
        public InputList<Inputs.ElbSourceFilterGetArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.ElbSourceFilterGetArgs>());
            set => _filters = value;
        }
        ...
        /// </summary>
        [Input("path")]
        public Input<Inputs.ElbSourcePathGetArgs>? Path { get; set; }
