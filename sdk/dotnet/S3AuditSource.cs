...
namespace Pulumi.SumoLogic
{
    ...
    public partial class S3AuditSource : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.S3AuditSourceDefaultDateFormat>> DefaultDateFormats { get; private set; } = null!;
        ...
        [Output("filters")]
        public Output<ImmutableArray<Outputs.S3AuditSourceFilter>> Filters { get; private set; } = null!;
        ...
        public S3AuditSource(string name, S3AuditSourceArgs args, CustomResourceOptions? options = null)
            : base("sumologic:index/s3AuditSource:S3AuditSource", name, args ?? new S3AuditSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private S3AuditSource(string name, Input<string> id, S3AuditSourceState? state = null, CustomResourceOptions? options = null)
            : base("sumologic:index/s3AuditSource:S3AuditSource", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static S3AuditSource Get(string name, Input<string> id, S3AuditSourceState? state = null, CustomResourceOptions? options = null)
        {
            return new S3AuditSource(name, id, state, options);
        }
    }

    public sealed class S3AuditSourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Authentication details for connecting to the S3 bucket.
        /// </summary>
        ...
        private InputList<Inputs.S3AuditSourceDefaultDateFormatArgs>? _defaultDateFormats;
        public InputList<Inputs.S3AuditSourceDefaultDateFormatArgs> DefaultDateFormats
        {
            get => _defaultDateFormats ?? (_defaultDateFormats = new InputList<Inputs.S3AuditSourceDefaultDateFormatArgs>());
        ...
        [Input("filters")]
        private InputList<Inputs.S3AuditSourceFilterArgs>? _filters;
        public InputList<Inputs.S3AuditSourceFilterArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.S3AuditSourceFilterArgs>());
            set => _filters = value;
        }
        ...
        public S3AuditSourceArgs()
        {
        }
        public static new S3AuditSourceArgs Empty => new S3AuditSourceArgs();
    }

    public sealed class S3AuditSourceState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Authentication details for connecting to the S3 bucket.
        /// </summary>
        ...
        [Input("defaultDateFormats")]
        private InputList<Inputs.S3AuditSourceDefaultDateFormatGetArgs>? _defaultDateFormats;
        public InputList<Inputs.S3AuditSourceDefaultDateFormatGetArgs> DefaultDateFormats
        {
            get => _defaultDateFormats ?? (_defaultDateFormats = new InputList<Inputs.S3AuditSourceDefaultDateFormatGetArgs>());
            set => _defaultDateFormats = value;
        }
        ...
        [Input("filters")]
        private InputList<Inputs.S3AuditSourceFilterGetArgs>? _filters;
        public InputList<Inputs.S3AuditSourceFilterGetArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.S3AuditSourceFilterGetArgs>());
            set => _filters = value;
        }
        ...
        public S3AuditSourceState()
        {
        }
        public static new S3AuditSourceState Empty => new S3AuditSourceState();
    }
}
