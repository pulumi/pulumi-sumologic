...
namespace Pulumi.SumoLogic.Inputs
{
    ...
    public sealed class GcpMetricsSourcePathArgs : global::Pulumi.ResourceArgs
    {
        [Input("azureTagFilters")]
        private InputList<Inputs.GcpMetricsSourcePathAzureTagFilterArgs>? _azureTagFilters;
        public InputList<Inputs.GcpMetricsSourcePathAzureTagFilterArgs> AzureTagFilters
        {
            get => _azureTagFilters ?? (_azureTagFilters = new InputList<Inputs.GcpMetricsSourcePathAzureTagFilterArgs>());
        ...
        /// </summary>
        public InputList<Inputs.GcpMetricsSourcePathCustomServiceArgs> CustomServices
        {
        ...
        public InputList<Inputs.GcpMetricsSourcePathSnsTopicOrSubscriptionArnArgs> SnsTopicOrSubscriptionArns
        {
            get => _snsTopicOrSubscriptionArns ?? (_snsTopicOrSubscriptionArns = new InputList<Inputs.GcpMetricsSourcePathSnsTopicOrSubscriptionArnArgs>());
            set => _snsTopicOrSubscriptionArns = value;
        }

        [Input("tagFilters")]
        private InputList<Inputs.GcpMetricsSourcePathTagFilterArgs>? _tagFilters;
        public InputList<Inputs.GcpMetricsSourcePathTagFilterArgs> TagFilters
        {
            get => _tagFilters ?? (_tagFilters = new InputList<Inputs.GcpMetricsSourcePathTagFilterArgs>());
        ...
        public GcpMetricsSourcePathArgs()
        {
        }
        public static new GcpMetricsSourcePathArgs Empty => new GcpMetricsSourcePathArgs();
    }
}
