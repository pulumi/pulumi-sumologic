...
namespace Pulumi.SumoLogic.Inputs
{
    ...
    public sealed class CseMatchRuleSeverityMappingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("mappings")]
        private InputList<Inputs.CseMatchRuleSeverityMappingMappingArgs>? _mappings;

        /// <summary>
        /// The map of record values to severities to use in the "fieldValueMapping" case
        /// </summary>
        public InputList<Inputs.CseMatchRuleSeverityMappingMappingArgs> Mappings
        {
            get => _mappings ?? (_mappings = new InputList<Inputs.CseMatchRuleSeverityMappingMappingArgs>());
            set => _mappings = value;
        }
        ...
        public CseMatchRuleSeverityMappingArgs()
        {
        }
        public static new CseMatchRuleSeverityMappingArgs Empty => new CseMatchRuleSeverityMappingArgs();
    }
}
