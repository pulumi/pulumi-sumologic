...
namespace Pulumi.SumoLogic.Inputs
{
    ...
    public sealed class S3SourcePathArgs : global::Pulumi.ResourceArgs
    {
        [Input("azureTagFilters")]
        private InputList<Inputs.S3SourcePathAzureTagFilterArgs>? _azureTagFilters;
        public InputList<Inputs.S3SourcePathAzureTagFilterArgs> AzureTagFilters
        {
            get => _azureTagFilters ?? (_azureTagFilters = new InputList<Inputs.S3SourcePathAzureTagFilterArgs>());
        ...
        private InputList<Inputs.S3SourcePathCustomServiceArgs>? _customServices;
        public InputList<Inputs.S3SourcePathCustomServiceArgs> CustomServices
        {
            get => _customServices ?? (_customServices = new InputList<Inputs.S3SourcePathCustomServiceArgs>());
        ...
        private InputList<Inputs.S3SourcePathSnsTopicOrSubscriptionArnArgs>? _snsTopicOrSubscriptionArns;

        /// <summary>
        /// This is a computed field for SNS topic/subscription ARN.
        /// </summary>
        public InputList<Inputs.S3SourcePathSnsTopicOrSubscriptionArnArgs> SnsTopicOrSubscriptionArns
        {
            get => _snsTopicOrSubscriptionArns ?? (_snsTopicOrSubscriptionArns = new InputList<Inputs.S3SourcePathSnsTopicOrSubscriptionArnArgs>());
        ...
        public static new S3SourcePathArgs Empty => new S3SourcePathArgs();
    }
}
