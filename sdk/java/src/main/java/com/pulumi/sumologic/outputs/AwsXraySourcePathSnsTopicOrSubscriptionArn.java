...
@CustomType
public final class AwsXraySourcePathSnsTopicOrSubscriptionArn {
    private final @Nullable String arn;
    private final @Nullable Boolean isSuccess;

    @CustomType.Constructor
    private AwsXraySourcePathSnsTopicOrSubscriptionArn(
    ...
    public static Builder builder(AwsXraySourcePathSnsTopicOrSubscriptionArn defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AwsXraySourcePathSnsTopicOrSubscriptionArn defaults) {
        ...
        public Builder isSuccess(@Nullable Boolean isSuccess) {
            ...
            return new AwsXraySourcePathSnsTopicOrSubscriptionArn(arn, isSuccess);
        }
    }
}
