...
public final class CseMatchRuleEntitySelector {
    ...
    public static final class Builder {
        ...
        public Builder entityType(String entityType) {
            if (entityType == null) {
              throw new MissingRequiredPropertyException("CseMatchRuleEntitySelector", "entityType");
            }
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("CseMatchRuleEntitySelector", "expression");
            }
