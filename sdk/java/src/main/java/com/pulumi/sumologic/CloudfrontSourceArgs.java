...
import com.pulumi.sumologic.inputs.CloudfrontSourceDefaultDateFormatArgs;
import com.pulumi.sumologic.inputs.CloudfrontSourceFilterArgs;
...
public final class CloudfrontSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudfrontSourceArgs Empty = new CloudfrontSourceArgs();
    ...
    private Output<CloudfrontSourceAuthenticationArgs> authentication;

    /**
     * @return Authentication details for connecting to the S3 bucket.
     * 
     */
    public Output<CloudfrontSourceAuthenticationArgs> authentication() {
    ...
    private @Nullable Output<List<CloudfrontSourceDefaultDateFormatArgs>> defaultDateFormats;

    public Optional<Output<List<CloudfrontSourceDefaultDateFormatArgs>>> defaultDateFormats() {
    ...
    @Import(name="filters")
    private @Nullable Output<List<CloudfrontSourceFilterArgs>> filters;

    public Optional<Output<List<CloudfrontSourceFilterArgs>>> filters() {
    ...
    private Output<CloudfrontSourcePathArgs> path;

    /**
     * @return The location to scan for new data.
     * 
     */
    public Output<CloudfrontSourcePathArgs> path() {
        return this.path;
    }
    ...
    private CloudfrontSourceArgs() {}

    private CloudfrontSourceArgs(CloudfrontSourceArgs $) {
    ...
    public static Builder builder(CloudfrontSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudfrontSourceArgs();
        }

        public Builder(CloudfrontSourceArgs defaults) {
            $ = new CloudfrontSourceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder authentication(Output<CloudfrontSourceAuthenticationArgs> authentication) {
         ...
         * 
         */
        public Builder authentication(CloudfrontSourceAuthenticationArgs authentication) {
        ...
        public Builder defaultDateFormats(@Nullable Output<List<CloudfrontSourceDefaultDateFormatArgs>> defaultDateFormats) {
            $.defaultDateFormats = defaultDateFormats;
            return this;
        }

        public Builder defaultDateFormats(List<CloudfrontSourceDefaultDateFormatArgs> defaultDateFormats) {
            return defaultDateFormats(Output.of(defaultDateFormats));
        }

        public Builder defaultDateFormats(CloudfrontSourceDefaultDateFormatArgs... defaultDateFormats) {
        ...
        public Builder filters(@Nullable Output<List<CloudfrontSourceFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<CloudfrontSourceFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(CloudfrontSourceFilterArgs... filters) {
         ...
         * 
         */
        public Builder path(Output<CloudfrontSourcePathArgs> path) {
            $.path = path;
            return this;
        }
         ...
         * 
         */
        public Builder path(CloudfrontSourcePathArgs path) {
        ...
        public CloudfrontSourceArgs build() {
            if ($.authentication == null) {
                throw new MissingRequiredPropertyException("CloudfrontSourceArgs", "authentication");
            }
            if ($.collectorId == null) {
                throw new MissingRequiredPropertyException("CloudfrontSourceArgs", "collectorId");
            }
            if ($.contentType == null) {
                throw new MissingRequiredPropertyException("CloudfrontSourceArgs", "contentType");
            }
            if ($.path == null) {
                throw new MissingRequiredPropertyException("CloudfrontSourceArgs", "path");
            }
            if ($.paused == null) {
                throw new MissingRequiredPropertyException("CloudfrontSourceArgs", "paused");
            }
            if ($.scanInterval == null) {
                throw new MissingRequiredPropertyException("CloudfrontSourceArgs", "scanInterval");
            }
            return $;
        }
    }
