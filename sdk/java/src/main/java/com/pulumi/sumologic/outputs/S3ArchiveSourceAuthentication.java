...
@CustomType
public final class S3ArchiveSourceAuthentication {
    /**
    ...
    public static Builder builder(S3ArchiveSourceAuthentication defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(S3ArchiveSourceAuthentication defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("S3ArchiveSourceAuthentication", "type");
            }
            this.type = type;
            return this;
        }
