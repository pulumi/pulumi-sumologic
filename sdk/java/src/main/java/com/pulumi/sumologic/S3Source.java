...
public class S3Source extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="authentication", type=S3SourceAuthentication.class, parameters={})
    ...
    @Export(name="defaultDateFormats", type=List.class, parameters={S3SourceDefaultDateFormat.class})
    ...
    @Export(name="filters", type=List.class, parameters={S3SourceFilter.class})
     ...
     * 
     */
    @Export(name="path", type=S3SourcePath.class, parameters={})
