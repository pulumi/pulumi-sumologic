...
@CustomType
public final class GcpSourceFilter {
    ...
    public static Builder builder(GcpSourceFilter defaults) {
    ...
    public static final class Builder {
        ...
        private String regexp;
        public Builder() {}
        public Builder(GcpSourceFilter defaults) {
        ...
        public Builder filterType(String filterType) {
            if (filterType == null) {
              throw new MissingRequiredPropertyException("GcpSourceFilter", "filterType");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GcpSourceFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder regexp(String regexp) {
            if (regexp == null) {
              throw new MissingRequiredPropertyException("GcpSourceFilter", "regexp");
            }
            this.regexp = regexp;
            return this;
        }
