...
public final class KinesisLogSourcePathArgs extends com.pulumi.resources.ResourceArgs {

    public static final KinesisLogSourcePathArgs Empty = new KinesisLogSourcePathArgs();
    ...
    private KinesisLogSourcePathArgs() {}

    private KinesisLogSourcePathArgs(KinesisLogSourcePathArgs $) {
    ...
    public static Builder builder(KinesisLogSourcePathArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KinesisLogSourcePathArgs();
        }

        public Builder(KinesisLogSourcePathArgs defaults) {
            $ = new KinesisLogSourcePathArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KinesisLogSourcePathArgs build() {
            return $;
        }
    }
