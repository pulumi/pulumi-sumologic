...
public final class PollingSourceState extends com.pulumi.resources.ResourceArgs {

    public static final PollingSourceState Empty = new PollingSourceState();
    ...
    private @Nullable Output<PollingSourceAuthenticationArgs> authentication;

    /**
     * @return Authentication details for connecting to the S3 bucket.
     * 
     */
    public Optional<Output<PollingSourceAuthenticationArgs>> authentication() {
     ...
     */
    @Import(name="path")
    private @Nullable Output<PollingSourcePathArgs> path;

    /**
     * @return The location to scan for new data.
     * 
     */
    public Optional<Output<PollingSourcePathArgs>> path() {
    ...
    private PollingSourceState() {}

    private PollingSourceState(PollingSourceState $) {
    ...
    public static Builder builder(PollingSourceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PollingSourceState();
        }

        public Builder(PollingSourceState defaults) {
            $ = new PollingSourceState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder authentication(@Nullable Output<PollingSourceAuthenticationArgs> authentication) {
         ...
         * 
         */
        public Builder path(@Nullable Output<PollingSourcePathArgs> path) {
            $.path = path;
            return this;
        }
        ...
        public PollingSourceState build() {
            return $;
        }
    }
