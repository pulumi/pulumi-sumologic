    ...
    public static final class Builder {
        ...
        public DashboardColoringRuleArgs build() {
            if ($.multipleSeriesAggregateFunction == null) {
                throw new MissingRequiredPropertyException("DashboardColoringRuleArgs", "multipleSeriesAggregateFunction");
            }
            if ($.scope == null) {
                throw new MissingRequiredPropertyException("DashboardColoringRuleArgs", "scope");
            }
            if ($.singleSeriesAggregateFunction == null) {
                throw new MissingRequiredPropertyException("DashboardColoringRuleArgs", "singleSeriesAggregateFunction");
            }
            return $;
        }
    }
