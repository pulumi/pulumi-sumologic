...
public final class HierarchyLevelNextLevelsWithConditionLevelNextLevelNextLevelNextLevelNextLevel {
    ...
    public static final class Builder {
        ...
        public Builder entityType(String entityType) {
            if (entityType == null) {
              throw new MissingRequiredPropertyException("HierarchyLevelNextLevelsWithConditionLevelNextLevelNextLevelNextLevelNextLevel", "entityType");
            }
        ...
        public HierarchyLevelNextLevelsWithConditionLevelNextLevelNextLevelNextLevelNextLevel build() {
            final var _resultValue = new HierarchyLevelNextLevelsWithConditionLevelNextLevelNextLevelNextLevelNextLevel();
