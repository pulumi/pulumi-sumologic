...
public final class HierarchyLevelNextLevelNextLevel {
     ...
     * 
     */
    private final @Nullable HierarchyLevelNextLevelNextLevelNextLevel nextLevel;
    /**
     * @return Zero or more next levels with conditions.
     * 
     */
    private final @Nullable List<HierarchyLevelNextLevelNextLevelNextLevelsWithCondition> nextLevelsWithConditions;

    @CustomType.Constructor
    private HierarchyLevelNextLevelNextLevel(
        @CustomType.Parameter("entityType") String entityType,
        @CustomType.Parameter("nextLevel") @Nullable HierarchyLevelNextLevelNextLevelNextLevel nextLevel,
        @CustomType.Parameter("nextLevelsWithConditions") @Nullable List<HierarchyLevelNextLevelNextLevelNextLevelsWithCondition> nextLevelsWithConditions) {
    ...
    public static final class Builder {
        ...
        public Builder nextLevelsWithConditions(HierarchyLevelNextLevelNextLevelNextLevelsWithCondition... nextLevelsWithConditions) {
            ...
            return new HierarchyLevelNextLevelNextLevel(entityType, nextLevel, nextLevelsWithConditions);
        }
    }
}
