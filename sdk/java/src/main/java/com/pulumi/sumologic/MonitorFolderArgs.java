...
public final class MonitorFolderArgs extends com.pulumi.resources.ResourceArgs {

    public static final MonitorFolderArgs Empty = new MonitorFolderArgs();
    ...
    private MonitorFolderArgs() {}

    private MonitorFolderArgs(MonitorFolderArgs $) {
    ...
    public static Builder builder(MonitorFolderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MonitorFolderArgs();
        }

        public Builder(MonitorFolderArgs defaults) {
            $ = new MonitorFolderArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MonitorFolderArgs build() {
            if ($.description == null) {
                throw new MissingRequiredPropertyException("MonitorFolderArgs", "description");
            }
            return $;
        }
    }
