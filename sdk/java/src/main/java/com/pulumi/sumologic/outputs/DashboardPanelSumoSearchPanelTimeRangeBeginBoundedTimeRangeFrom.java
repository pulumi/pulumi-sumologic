...
public final class DashboardPanelSumoSearchPanelTimeRangeBeginBoundedTimeRangeFrom {
    private final @Nullable DashboardPanelSumoSearchPanelTimeRangeBeginBoundedTimeRangeFromEpochTimeRange epochTimeRange;
    private final @Nullable DashboardPanelSumoSearchPanelTimeRangeBeginBoundedTimeRangeFromIso8601TimeRange iso8601TimeRange;
    private final @Nullable DashboardPanelSumoSearchPanelTimeRangeBeginBoundedTimeRangeFromLiteralTimeRange literalTimeRange;
    private final @Nullable DashboardPanelSumoSearchPanelTimeRangeBeginBoundedTimeRangeFromRelativeTimeRange relativeTimeRange;

    @CustomType.Constructor
    private DashboardPanelSumoSearchPanelTimeRangeBeginBoundedTimeRangeFrom(
        @CustomType.Parameter("epochTimeRange") @Nullable DashboardPanelSumoSearchPanelTimeRangeBeginBoundedTimeRangeFromEpochTimeRange epochTimeRange,
        @CustomType.Parameter("iso8601TimeRange") @Nullable DashboardPanelSumoSearchPanelTimeRangeBeginBoundedTimeRangeFromIso8601TimeRange iso8601TimeRange,
        @CustomType.Parameter("literalTimeRange") @Nullable DashboardPanelSumoSearchPanelTimeRangeBeginBoundedTimeRangeFromLiteralTimeRange literalTimeRange,
        @CustomType.Parameter("relativeTimeRange") @Nullable DashboardPanelSumoSearchPanelTimeRangeBeginBoundedTimeRangeFromRelativeTimeRange relativeTimeRange) {
    ...
    public static final class Builder {
        ...
        public Builder relativeTimeRange(@Nullable DashboardPanelSumoSearchPanelTimeRangeBeginBoundedTimeRangeFromRelativeTimeRange relativeTimeRange) {
            ...
            return new DashboardPanelSumoSearchPanelTimeRangeBeginBoundedTimeRangeFrom(epochTimeRange, iso8601TimeRange, literalTimeRange, relativeTimeRange);
        }
    }
}
