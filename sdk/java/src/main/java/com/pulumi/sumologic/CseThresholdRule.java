...
public class CseThresholdRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public CseThresholdRule(java.lang.String name) {
     ...
     */
    public CseThresholdRule(java.lang.String name, CseThresholdRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CseThresholdRule(java.lang.String name, CseThresholdRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/cseThresholdRule:CseThresholdRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CseThresholdRule(java.lang.String name, Output<java.lang.String> id, @Nullable CseThresholdRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/cseThresholdRule:CseThresholdRule", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static CseThresholdRule get(java.lang.String name, Output<java.lang.String> id, @Nullable CseThresholdRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
