...
import com.pulumi.sumologic.inputs.S3ArchiveSourceDefaultDateFormatArgs;
import com.pulumi.sumologic.inputs.S3ArchiveSourceFilterArgs;
...
public final class S3ArchiveSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final S3ArchiveSourceArgs Empty = new S3ArchiveSourceArgs();
    ...
    private Output<S3ArchiveSourceAuthenticationArgs> authentication;

    /**
     * @return Authentication details for connecting to the S3 bucket.
     * 
     */
    public Output<S3ArchiveSourceAuthenticationArgs> authentication() {
    ...
    private @Nullable Output<List<S3ArchiveSourceDefaultDateFormatArgs>> defaultDateFormats;

    public Optional<Output<List<S3ArchiveSourceDefaultDateFormatArgs>>> defaultDateFormats() {
    ...
    @Import(name="filters")
    private @Nullable Output<List<S3ArchiveSourceFilterArgs>> filters;

    public Optional<Output<List<S3ArchiveSourceFilterArgs>>> filters() {
    ...
    private Output<S3ArchiveSourcePathArgs> path;

    /**
     * @return The location to scan for new data.
     * 
     */
    public Output<S3ArchiveSourcePathArgs> path() {
        return this.path;
    }
    ...
    private S3ArchiveSourceArgs() {}

    private S3ArchiveSourceArgs(S3ArchiveSourceArgs $) {
    ...
    public static Builder builder(S3ArchiveSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new S3ArchiveSourceArgs();
        }

        public Builder(S3ArchiveSourceArgs defaults) {
            $ = new S3ArchiveSourceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder authentication(Output<S3ArchiveSourceAuthenticationArgs> authentication) {
         ...
         * 
         */
        public Builder authentication(S3ArchiveSourceAuthenticationArgs authentication) {
        ...
        /**
         * @param contentType The content-type of the collected data. It should be `AwsS3ArchiveBucket` for archive source. Details can be found in the [Sumologic documentation for hosted sources](https://help.sumologic.com/Send_Data/Sources/03Use_JSON_to_Configure_Sources/JSON_Parameters_for_Hosted_Sources).
         * 
         * @return builder
         * 
         */
        ...
        public Builder defaultDateFormats(@Nullable Output<List<S3ArchiveSourceDefaultDateFormatArgs>> defaultDateFormats) {
            $.defaultDateFormats = defaultDateFormats;
            return this;
        }

        public Builder defaultDateFormats(List<S3ArchiveSourceDefaultDateFormatArgs> defaultDateFormats) {
            return defaultDateFormats(Output.of(defaultDateFormats));
        }

        public Builder defaultDateFormats(S3ArchiveSourceDefaultDateFormatArgs... defaultDateFormats) {
        ...
        public Builder filters(@Nullable Output<List<S3ArchiveSourceFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<S3ArchiveSourceFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(S3ArchiveSourceFilterArgs... filters) {
         ...
         * 
         */
        public Builder path(Output<S3ArchiveSourcePathArgs> path) {
            $.path = path;
            return this;
        }
         ...
         * 
         */
        public Builder path(S3ArchiveSourcePathArgs path) {
        ...
        public S3ArchiveSourceArgs build() {
            if ($.authentication == null) {
                throw new MissingRequiredPropertyException("S3ArchiveSourceArgs", "authentication");
            }
            if ($.collectorId == null) {
                throw new MissingRequiredPropertyException("S3ArchiveSourceArgs", "collectorId");
            }
            if ($.contentType == null) {
                throw new MissingRequiredPropertyException("S3ArchiveSourceArgs", "contentType");
            }
            if ($.path == null) {
                throw new MissingRequiredPropertyException("S3ArchiveSourceArgs", "path");
            }
            if ($.paused == null) {
                throw new MissingRequiredPropertyException("S3ArchiveSourceArgs", "paused");
            }
            if ($.scanInterval == null) {
                throw new MissingRequiredPropertyException("S3ArchiveSourceArgs", "scanInterval");
            }
            return $;
        }
    }
