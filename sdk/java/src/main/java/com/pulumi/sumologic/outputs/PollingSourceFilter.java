...
@CustomType
public final class PollingSourceFilter {
    private String filterType;
    private @Nullable String mask;
    private String name;
    private String regexp;

    private PollingSourceFilter() {}
    ...
    public static Builder builder(PollingSourceFilter defaults) {
    ...
    public static final class Builder {
        ...
        private String regexp;
        public Builder() {}
        public Builder(PollingSourceFilter defaults) {
        ...
        public Builder filterType(String filterType) {
            if (filterType == null) {
              throw new MissingRequiredPropertyException("PollingSourceFilter", "filterType");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PollingSourceFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder regexp(String regexp) {
            if (regexp == null) {
              throw new MissingRequiredPropertyException("PollingSourceFilter", "regexp");
            }
            this.regexp = regexp;
            return this;
        }
