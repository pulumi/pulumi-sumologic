...
public final class LogSearchScheduleParseableTimeRangeBeginBoundedTimeRangeFromEpochTimeRange {
    ...
    public static Builder builder(LogSearchScheduleParseableTimeRangeBeginBoundedTimeRangeFromEpochTimeRange defaults) {
    ...
    public static final class Builder {
        private Integer epochMillis;
        public Builder() {}
        public Builder(LogSearchScheduleParseableTimeRangeBeginBoundedTimeRangeFromEpochTimeRange defaults) {
        ...
        public Builder epochMillis(Integer epochMillis) {
            if (epochMillis == null) {
              throw new MissingRequiredPropertyException("LogSearchScheduleParseableTimeRangeBeginBoundedTimeRangeFromEpochTimeRange", "epochMillis");
            }
