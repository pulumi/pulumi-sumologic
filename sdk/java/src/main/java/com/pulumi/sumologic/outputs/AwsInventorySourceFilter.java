...
public final class AwsInventorySourceFilter {
    ...
    public static final class Builder {
        ...
        public Builder filterType(String filterType) {
            if (filterType == null) {
              throw new MissingRequiredPropertyException("AwsInventorySourceFilter", "filterType");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("AwsInventorySourceFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder regexp(String regexp) {
            if (regexp == null) {
              throw new MissingRequiredPropertyException("AwsInventorySourceFilter", "regexp");
            }
            this.regexp = regexp;
            return this;
        }
        public AwsInventorySourceFilter build() {
            final var _resultValue = new AwsInventorySourceFilter();
