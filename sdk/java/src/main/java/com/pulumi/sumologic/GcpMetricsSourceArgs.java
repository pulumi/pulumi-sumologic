...
public final class GcpMetricsSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final GcpMetricsSourceArgs Empty = new GcpMetricsSourceArgs();
    ...
    private Output<GcpMetricsSourceAuthenticationArgs> authentication;

    /**
     * @return Authentication details for connecting to the  GCP Monitoring using service_account credentials.
     * 
     */
    public Output<GcpMetricsSourceAuthenticationArgs> authentication() {
    ...
    private Output<GcpMetricsSourcePathArgs> path;

    /**
     * @return Details about what data to ingest
     * 
     */
    public Output<GcpMetricsSourcePathArgs> path() {
        return this.path;
    }
    ...
    private GcpMetricsSourceArgs() {}

    private GcpMetricsSourceArgs(GcpMetricsSourceArgs $) {
    ...
    public static Builder builder(GcpMetricsSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GcpMetricsSourceArgs();
        }

        public Builder(GcpMetricsSourceArgs defaults) {
            $ = new GcpMetricsSourceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder authentication(Output<GcpMetricsSourceAuthenticationArgs> authentication) {
         ...
         * 
         */
        public Builder path(Output<GcpMetricsSourcePathArgs> path) {
            $.path = path;
            return this;
        }
