...
public final class LogSearchState extends com.pulumi.resources.ResourceArgs {

    public static final LogSearchState Empty = new LogSearchState();
    ...
    public static Builder builder(LogSearchState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LogSearchState defaults) {
            $ = new LogSearchState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder timeRange(@Nullable Output<LogSearchTimeRangeArgs> timeRange) {
            $.timeRange = timeRange;
            return this;
        }
