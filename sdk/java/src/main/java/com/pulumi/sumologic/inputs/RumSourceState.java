...
public final class RumSourceState extends com.pulumi.resources.ResourceArgs {

    public static final RumSourceState Empty = new RumSourceState();
    ...
    private @Nullable Output<List<RumSourceDefaultDateFormatArgs>> defaultDateFormats;

    public Optional<Output<List<RumSourceDefaultDateFormatArgs>>> defaultDateFormats() {
    ...
    @Import(name="filters")
    private @Nullable Output<List<RumSourceFilterArgs>> filters;

    public Optional<Output<List<RumSourceFilterArgs>>> filters() {
    ...
    @Import(name="path")
    private @Nullable Output<RumSourcePathArgs> path;

    public Optional<Output<RumSourcePathArgs>> path() {
    ...
    private RumSourceState(RumSourceState $) {
    ...
    public static Builder builder(RumSourceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RumSourceState defaults) {
            $ = new RumSourceState(Objects.requireNonNull(defaults));
        }
        ...
        public Builder defaultDateFormats(@Nullable Output<List<RumSourceDefaultDateFormatArgs>> defaultDateFormats) {
            $.defaultDateFormats = defaultDateFormats;
            return this;
        }

        public Builder defaultDateFormats(List<RumSourceDefaultDateFormatArgs> defaultDateFormats) {
            return defaultDateFormats(Output.of(defaultDateFormats));
        }

        public Builder defaultDateFormats(RumSourceDefaultDateFormatArgs... defaultDateFormats) {
        ...
        public Builder filters(@Nullable Output<List<RumSourceFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<RumSourceFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(RumSourceFilterArgs... filters) {
        ...
        public Builder path(@Nullable Output<RumSourcePathArgs> path) {
            $.path = path;
            return this;
        }

        public Builder path(RumSourcePathArgs path) {
