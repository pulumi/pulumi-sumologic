...
public final class S3SourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final S3SourceArgs Empty = new S3SourceArgs();
    ...
    private Output<S3SourceAuthenticationArgs> authentication;

    /**
     * @return Authentication details for connecting to the S3 bucket.
     * 
     */
    public Output<S3SourceAuthenticationArgs> authentication() {
    ...
    private Output<S3SourcePathArgs> path;

    /**
     * @return The location to scan for new data.
     * 
     */
    public Output<S3SourcePathArgs> path() {
        return this.path;
    }
    ...
    private S3SourceArgs() {}

    private S3SourceArgs(S3SourceArgs $) {
    ...
    public static Builder builder(S3SourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(S3SourceArgs defaults) {
            $ = new S3SourceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder authentication(Output<S3SourceAuthenticationArgs> authentication) {
         ...
         * 
         */
        public Builder path(Output<S3SourcePathArgs> path) {
            $.path = path;
            return this;
        }
