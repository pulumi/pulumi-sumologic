...
@CustomType
public final class S3SourceAuthentication {
    /**
    ...
    private S3SourceAuthentication(
    ...
    public static Builder builder(S3SourceAuthentication defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(S3SourceAuthentication defaults) {
        ...
        public Builder type(String type) {
            ...
            return this;
        }        public S3SourceAuthentication build() {
            return new S3SourceAuthentication(accessKey, authProviderX509CertUrl, authUri, clientEmail, clientId, clientX509CertUrl, privateKey, privateKeyId, projectId, region, roleArn, secretKey, tokenUri, type);
        }
    }
}
