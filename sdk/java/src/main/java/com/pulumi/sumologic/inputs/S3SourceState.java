...
public final class S3SourceState extends com.pulumi.resources.ResourceArgs {

    public static final S3SourceState Empty = new S3SourceState();
    ...
    private @Nullable Output<S3SourceAuthenticationArgs> authentication;

    /**
     * @return Authentication details for connecting to the S3 bucket.
     * 
     */
    public Optional<Output<S3SourceAuthenticationArgs>> authentication() {
    ...
    private @Nullable Output<List<S3SourceDefaultDateFormatArgs>> defaultDateFormats;

    public Optional<Output<List<S3SourceDefaultDateFormatArgs>>> defaultDateFormats() {
    ...
    @Import(name="filters")
    private @Nullable Output<List<S3SourceFilterArgs>> filters;

    public Optional<Output<List<S3SourceFilterArgs>>> filters() {
     ...
     */
    @Import(name="path")
    private @Nullable Output<S3SourcePathArgs> path;

    /**
     * @return The location to scan for new data.
     * 
     */
    public Optional<Output<S3SourcePathArgs>> path() {
    ...
    private S3SourceState() {}

    private S3SourceState(S3SourceState $) {
    ...
    public static Builder builder(S3SourceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(S3SourceState defaults) {
            $ = new S3SourceState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder authentication(@Nullable Output<S3SourceAuthenticationArgs> authentication) {
         ...
         * 
         */
        public Builder authentication(S3SourceAuthenticationArgs authentication) {
        ...
        public Builder defaultDateFormats(@Nullable Output<List<S3SourceDefaultDateFormatArgs>> defaultDateFormats) {
            $.defaultDateFormats = defaultDateFormats;
            return this;
        }

        public Builder defaultDateFormats(List<S3SourceDefaultDateFormatArgs> defaultDateFormats) {
            return defaultDateFormats(Output.of(defaultDateFormats));
        }

        public Builder defaultDateFormats(S3SourceDefaultDateFormatArgs... defaultDateFormats) {
        ...
        public Builder filters(@Nullable Output<List<S3SourceFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<S3SourceFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(S3SourceFilterArgs... filters) {
         ...
         * 
         */
        public Builder path(@Nullable Output<S3SourcePathArgs> path) {
            $.path = path;
            return this;
        }
         ...
         * 
         */
        public Builder path(S3SourcePathArgs path) {
