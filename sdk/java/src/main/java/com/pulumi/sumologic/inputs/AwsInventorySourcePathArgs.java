...
public final class AwsInventorySourcePathArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<AwsInventorySourcePathCustomServiceArgs>> customServices;
    ...
    private @Nullable Output<List<AwsInventorySourcePathSnsTopicOrSubscriptionArnArgs>> snsTopicOrSubscriptionArns;

    public Optional<Output<List<AwsInventorySourcePathSnsTopicOrSubscriptionArnArgs>>> snsTopicOrSubscriptionArns() {
        return Optional.ofNullable(this.snsTopicOrSubscriptionArns);
    }

    @Import(name="tagFilters")
    private @Nullable Output<List<AwsInventorySourcePathTagFilterArgs>> tagFilters;

    public Optional<Output<List<AwsInventorySourcePathTagFilterArgs>>> tagFilters() {
    ...
    public static Builder builder(AwsInventorySourcePathArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsInventorySourcePathArgs();
        }

        public Builder(AwsInventorySourcePathArgs defaults) {
        ...
        public Builder customServices(@Nullable Output<List<AwsInventorySourcePathCustomServiceArgs>> customServices) {
            $.customServices = customServices;
            return this;
        }

        public Builder customServices(List<AwsInventorySourcePathCustomServiceArgs> customServices) {
        ...
        /**
         * @param limitToNamespaces List of namespaces. By default all namespaces are selected. You can also choose a subset from
         * + AWS/EC2
         * + AWS/AutoScaling
         * + AWS/EBS
         * + AWS/ELB
        ...
        public Builder snsTopicOrSubscriptionArns(@Nullable Output<List<AwsInventorySourcePathSnsTopicOrSubscriptionArnArgs>> snsTopicOrSubscriptionArns) {
            $.snsTopicOrSubscriptionArns = snsTopicOrSubscriptionArns;
            return this;
        }

        public Builder snsTopicOrSubscriptionArns(List<AwsInventorySourcePathSnsTopicOrSubscriptionArnArgs> snsTopicOrSubscriptionArns) {
            return snsTopicOrSubscriptionArns(Output.of(snsTopicOrSubscriptionArns));
        }

        public Builder snsTopicOrSubscriptionArns(AwsInventorySourcePathSnsTopicOrSubscriptionArnArgs... snsTopicOrSubscriptionArns) {
            return snsTopicOrSubscriptionArns(List.of(snsTopicOrSubscriptionArns));
        }

        public Builder tagFilters(@Nullable Output<List<AwsInventorySourcePathTagFilterArgs>> tagFilters) {
            $.tagFilters = tagFilters;
            return this;
        }

        public Builder tagFilters(List<AwsInventorySourcePathTagFilterArgs> tagFilters) {
            return tagFilters(Output.of(tagFilters));
        }

        public Builder tagFilters(AwsInventorySourcePathTagFilterArgs... tagFilters) {
