...
public class S3ArchiveSource extends com.pulumi.resources.CustomResource {
     ...
     */
    public S3ArchiveSource(java.lang.String name) {
     ...
     */
    public S3ArchiveSource(java.lang.String name, S3ArchiveSourceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public S3ArchiveSource(java.lang.String name, S3ArchiveSourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/s3ArchiveSource:S3ArchiveSource", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private S3ArchiveSource(java.lang.String name, Output<java.lang.String> id, @Nullable S3ArchiveSourceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/s3ArchiveSource:S3ArchiveSource", name, state, makeResourceOptions(options, id), false);
    }

    private static S3ArchiveSourceArgs makeArgs(S3ArchiveSourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? S3ArchiveSourceArgs.Empty : args;
    }
     ...
     */
    public static S3ArchiveSource get(java.lang.String name, Output<java.lang.String> id, @Nullable S3ArchiveSourceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
