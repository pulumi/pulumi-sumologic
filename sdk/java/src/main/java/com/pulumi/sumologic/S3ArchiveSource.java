...
public class S3ArchiveSource extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="authentication", type=S3ArchiveSourceAuthentication.class, parameters={})
    ...
    @Export(name="defaultDateFormats", type=List.class, parameters={S3ArchiveSourceDefaultDateFormat.class})
    ...
    @Export(name="filters", type=List.class, parameters={S3ArchiveSourceFilter.class})
     ...
     * 
     */
    @Export(name="path", type=S3ArchiveSourcePath.class, parameters={})
