...
import com.pulumi.sumologic.MetadataSourceArgs;
import com.pulumi.sumologic.Utilities;
import com.pulumi.sumologic.inputs.MetadataSourceState;
import com.pulumi.sumologic.outputs.MetadataSourceAuthentication;
import com.pulumi.sumologic.outputs.MetadataSourceDefaultDateFormat;
import com.pulumi.sumologic.outputs.MetadataSourceFilter;
import com.pulumi.sumologic.outputs.MetadataSourcePath;
 ...
 * 
 */
@ResourceType(type="sumologic:index/metadataSource:MetadataSource")
public class MetadataSource extends com.pulumi.resources.CustomResource {
    /**
     * Authentication details for AWS access.
     * 
     */
    @Export(name="authentication", refs={MetadataSourceAuthentication.class}, tree="[0]")
    private Output<MetadataSourceAuthentication> authentication;

    /**
     * @return Authentication details for AWS access.
     * 
     */
    public Output<MetadataSourceAuthentication> authentication() {
    ...
    @Export(name="defaultDateFormats", refs={List.class,MetadataSourceDefaultDateFormat.class}, tree="[0,1]")
    private Output</* @Nullable */ List<MetadataSourceDefaultDateFormat>> defaultDateFormats;

    public Output<Optional<List<MetadataSourceDefaultDateFormat>>> defaultDateFormats() {
    ...
    @Export(name="filters", refs={List.class,MetadataSourceFilter.class}, tree="[0,1]")
    private Output</* @Nullable */ List<MetadataSourceFilter>> filters;

    public Output<Optional<List<MetadataSourceFilter>>> filters() {
     ...
     * 
     */
    @Export(name="path", refs={MetadataSourcePath.class}, tree="[0]")
    private Output<MetadataSourcePath> path;

    /**
     * @return The location to scan for new data.
     * 
     */
    public Output<MetadataSourcePath> path() {
        return this.path;
    }
    /**
     ...
     */
    public MetadataSource(java.lang.String name) {
        this(name, MetadataSourceArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public MetadataSource(java.lang.String name, MetadataSourceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MetadataSource(java.lang.String name, MetadataSourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/metadataSource:MetadataSource", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MetadataSource(java.lang.String name, Output<java.lang.String> id, @Nullable MetadataSourceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/metadataSource:MetadataSource", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static MetadataSource get(java.lang.String name, Output<java.lang.String> id, @Nullable MetadataSourceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
