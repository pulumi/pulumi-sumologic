...
public class MetadataSource extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="authentication", type=MetadataSourceAuthentication.class, parameters={})
    ...
    @Export(name="defaultDateFormats", type=List.class, parameters={MetadataSourceDefaultDateFormat.class})
    ...
    @Export(name="filters", type=List.class, parameters={MetadataSourceFilter.class})
     ...
     * 
     */
    @Export(name="path", type=MetadataSourcePath.class, parameters={})
     ...
     */
    public static MetadataSource get(String name, Output<String> id, @Nullable MetadataSourceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
