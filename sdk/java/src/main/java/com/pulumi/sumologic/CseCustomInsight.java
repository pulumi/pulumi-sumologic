...
public class CseCustomInsight extends com.pulumi.resources.CustomResource {
     ...
     */
    public CseCustomInsight(java.lang.String name) {
     ...
     */
    public CseCustomInsight(java.lang.String name, CseCustomInsightArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CseCustomInsight(java.lang.String name, CseCustomInsightArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/cseCustomInsight:CseCustomInsight", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CseCustomInsight(java.lang.String name, Output<java.lang.String> id, @Nullable CseCustomInsightState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/cseCustomInsight:CseCustomInsight", name, state, makeResourceOptions(options, id), false);
    }

    private static CseCustomInsightArgs makeArgs(CseCustomInsightArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CseCustomInsightArgs.Empty : args;
    }
     ...
     */
    public static CseCustomInsight get(java.lang.String name, Output<java.lang.String> id, @Nullable CseCustomInsightState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
