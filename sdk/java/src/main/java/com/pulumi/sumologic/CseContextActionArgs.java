...
public final class CseContextActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final CseContextActionArgs Empty = new CseContextActionArgs();
     ...
     * 
     */
    @Import(name="iocTypes", required=true)
    ...
    private CseContextActionArgs() {}

    private CseContextActionArgs(CseContextActionArgs $) {
    ...
    public static Builder builder(CseContextActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CseContextActionArgs();
        }

        public Builder(CseContextActionArgs defaults) {
            $ = new CseContextActionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder iocTypes(Output<List<String>> iocTypes) {
            $.iocTypes = iocTypes;
            return this;
        }
