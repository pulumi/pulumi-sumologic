...
import com.pulumi.sumologic.inputs.S3ArchiveSourcePathAzureTagFilterArgs;
import com.pulumi.sumologic.inputs.S3ArchiveSourcePathCustomServiceArgs;
import com.pulumi.sumologic.inputs.S3ArchiveSourcePathSnsTopicOrSubscriptionArnArgs;
import com.pulumi.sumologic.inputs.S3ArchiveSourcePathTagFilterArgs;
...
public final class S3ArchiveSourcePathArgs extends com.pulumi.resources.ResourceArgs {

    public static final S3ArchiveSourcePathArgs Empty = new S3ArchiveSourcePathArgs();

    @Import(name="azureTagFilters")
    private @Nullable Output<List<S3ArchiveSourcePathAzureTagFilterArgs>> azureTagFilters;

    public Optional<Output<List<S3ArchiveSourcePathAzureTagFilterArgs>>> azureTagFilters() {
    ...
    private @Nullable Output<List<S3ArchiveSourcePathCustomServiceArgs>> customServices;

    public Optional<Output<List<S3ArchiveSourcePathCustomServiceArgs>>> customServices() {
    ...
    private @Nullable Output<List<S3ArchiveSourcePathSnsTopicOrSubscriptionArnArgs>> snsTopicOrSubscriptionArns;

    public Optional<Output<List<S3ArchiveSourcePathSnsTopicOrSubscriptionArnArgs>>> snsTopicOrSubscriptionArns() {
        return Optional.ofNullable(this.snsTopicOrSubscriptionArns);
    }

    @Import(name="tagFilters")
    private @Nullable Output<List<S3ArchiveSourcePathTagFilterArgs>> tagFilters;

    public Optional<Output<List<S3ArchiveSourcePathTagFilterArgs>>> tagFilters() {
    ...
    private S3ArchiveSourcePathArgs() {}

    private S3ArchiveSourcePathArgs(S3ArchiveSourcePathArgs $) {
    ...
    public static Builder builder(S3ArchiveSourcePathArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new S3ArchiveSourcePathArgs();
        }

        public Builder(S3ArchiveSourcePathArgs defaults) {
            $ = new S3ArchiveSourcePathArgs(Objects.requireNonNull(defaults));
        }

        public Builder azureTagFilters(@Nullable Output<List<S3ArchiveSourcePathAzureTagFilterArgs>> azureTagFilters) {
            $.azureTagFilters = azureTagFilters;
            return this;
        }

        public Builder azureTagFilters(List<S3ArchiveSourcePathAzureTagFilterArgs> azureTagFilters) {
            return azureTagFilters(Output.of(azureTagFilters));
        }

        public Builder azureTagFilters(S3ArchiveSourcePathAzureTagFilterArgs... azureTagFilters) {
        ...
        public Builder customServices(@Nullable Output<List<S3ArchiveSourcePathCustomServiceArgs>> customServices) {
            $.customServices = customServices;
            return this;
        }

        public Builder customServices(List<S3ArchiveSourcePathCustomServiceArgs> customServices) {
            return customServices(Output.of(customServices));
        }

        public Builder customServices(S3ArchiveSourcePathCustomServiceArgs... customServices) {
        ...
        public Builder snsTopicOrSubscriptionArns(@Nullable Output<List<S3ArchiveSourcePathSnsTopicOrSubscriptionArnArgs>> snsTopicOrSubscriptionArns) {
            $.snsTopicOrSubscriptionArns = snsTopicOrSubscriptionArns;
            return this;
        }

        public Builder snsTopicOrSubscriptionArns(List<S3ArchiveSourcePathSnsTopicOrSubscriptionArnArgs> snsTopicOrSubscriptionArns) {
            return snsTopicOrSubscriptionArns(Output.of(snsTopicOrSubscriptionArns));
        }

        public Builder snsTopicOrSubscriptionArns(S3ArchiveSourcePathSnsTopicOrSubscriptionArnArgs... snsTopicOrSubscriptionArns) {
            return snsTopicOrSubscriptionArns(List.of(snsTopicOrSubscriptionArns));
        }

        public Builder tagFilters(@Nullable Output<List<S3ArchiveSourcePathTagFilterArgs>> tagFilters) {
            $.tagFilters = tagFilters;
            return this;
        }

        public Builder tagFilters(List<S3ArchiveSourcePathTagFilterArgs> tagFilters) {
            return tagFilters(Output.of(tagFilters));
        }

        public Builder tagFilters(S3ArchiveSourcePathTagFilterArgs... tagFilters) {
        ...
        public S3ArchiveSourcePathArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("S3ArchiveSourcePathArgs", "type");
            }
            return $;
        }
    }
