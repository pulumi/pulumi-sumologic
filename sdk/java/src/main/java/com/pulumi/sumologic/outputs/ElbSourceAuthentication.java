...
@CustomType
public final class ElbSourceAuthentication {
    /**
    ...
    public static Builder builder(ElbSourceAuthentication defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ElbSourceAuthentication defaults) {
        ...
        public Builder type(String type) {
            ...
            return this;
        }        public ElbSourceAuthentication build() {
            return new ElbSourceAuthentication(accessKey, authProviderX509CertUrl, authUri, clientEmail, clientId, clientX509CertUrl, privateKey, privateKeyId, projectId, region, roleArn, secretKey, tokenUri, type);
        }
    }
}
