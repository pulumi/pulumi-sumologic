...
public final class CseAggregationRuleEntitySelector {
    ...
    public static final class Builder {
        ...
        public Builder entityType(String entityType) {
            if (entityType == null) {
              throw new MissingRequiredPropertyException("CseAggregationRuleEntitySelector", "entityType");
            }
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("CseAggregationRuleEntitySelector", "expression");
            }
