...
public final class CseEntityNormalizationConfigurationDomainMappingArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public CseEntityNormalizationConfigurationDomainMappingArgs build() {
            $.normalizedDomain = Objects.requireNonNull($.normalizedDomain, "expected parameter 'normalizedDomain' to be non-null");
            $.rawDomain = Objects.requireNonNull($.rawDomain, "expected parameter 'rawDomain' to be non-null");
            return $;
        }
    }
