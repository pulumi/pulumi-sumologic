...
public final class CloudwatchSourceState extends com.pulumi.resources.ResourceArgs {

    public static final CloudwatchSourceState Empty = new CloudwatchSourceState();
    ...
    private @Nullable Output<CloudwatchSourceAuthenticationArgs> authentication;

    /**
     * @return Authentication details for connecting to the S3 bucket.
     * 
     */
    public Optional<Output<CloudwatchSourceAuthenticationArgs>> authentication() {
    ...
    private @Nullable Output<List<CloudwatchSourceDefaultDateFormatArgs>> defaultDateFormats;

    public Optional<Output<List<CloudwatchSourceDefaultDateFormatArgs>>> defaultDateFormats() {
    ...
    @Import(name="filters")
    private @Nullable Output<List<CloudwatchSourceFilterArgs>> filters;

    public Optional<Output<List<CloudwatchSourceFilterArgs>>> filters() {
     ...
     */
    @Import(name="path")
    private @Nullable Output<CloudwatchSourcePathArgs> path;

    /**
     * @return The location to scan for new data.
     * 
     */
    public Optional<Output<CloudwatchSourcePathArgs>> path() {
    ...
    private CloudwatchSourceState() {}

    private CloudwatchSourceState(CloudwatchSourceState $) {
    ...
    public static Builder builder(CloudwatchSourceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudwatchSourceState();
        }

        public Builder(CloudwatchSourceState defaults) {
            $ = new CloudwatchSourceState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder authentication(@Nullable Output<CloudwatchSourceAuthenticationArgs> authentication) {
        ...
        public Builder defaultDateFormats(@Nullable Output<List<CloudwatchSourceDefaultDateFormatArgs>> defaultDateFormats) {
            $.defaultDateFormats = defaultDateFormats;
            return this;
        }

        public Builder defaultDateFormats(List<CloudwatchSourceDefaultDateFormatArgs> defaultDateFormats) {
        ...
        public Builder filters(@Nullable Output<List<CloudwatchSourceFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<CloudwatchSourceFilterArgs> filters) {
         ...
         * 
         */
        public Builder path(@Nullable Output<CloudwatchSourcePathArgs> path) {
            $.path = path;
            return this;
        }
        ...
        public CloudwatchSourceState build() {
            return $;
        }
    }
