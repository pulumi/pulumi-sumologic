...
import com.pulumi.sumologic.inputs.MetadataSourceAuthenticationArgs;
import com.pulumi.sumologic.inputs.MetadataSourceDefaultDateFormatArgs;
import com.pulumi.sumologic.inputs.MetadataSourceFilterArgs;
import com.pulumi.sumologic.inputs.MetadataSourcePathArgs;
...
public final class MetadataSourceState extends com.pulumi.resources.ResourceArgs {

    public static final MetadataSourceState Empty = new MetadataSourceState();
    ...
    private @Nullable Output<MetadataSourceAuthenticationArgs> authentication;

    /**
     * @return Authentication details for AWS access.
     * 
     */
    public Optional<Output<MetadataSourceAuthenticationArgs>> authentication() {
    ...
    /**
     * @return The content-type of the collected data. For Metadata source this is `AwsMetadata`. Details can be found in the [Sumologic documentation for hosted sources](https://help.sumologic.com/Send_Data/Sources/03Use_JSON_to_Configure_Sources/JSON_Parameters_for_Hosted_Sources).
     * 
     */
    ...
    private @Nullable Output<List<MetadataSourceDefaultDateFormatArgs>> defaultDateFormats;

    public Optional<Output<List<MetadataSourceDefaultDateFormatArgs>>> defaultDateFormats() {
    ...
    @Import(name="filters")
    private @Nullable Output<List<MetadataSourceFilterArgs>> filters;

    public Optional<Output<List<MetadataSourceFilterArgs>>> filters() {
     ...
     */
    @Import(name="path")
    private @Nullable Output<MetadataSourcePathArgs> path;

    /**
     * @return The location to scan for new data.
     * 
     */
    public Optional<Output<MetadataSourcePathArgs>> path() {
    ...
    private MetadataSourceState() {}

    private MetadataSourceState(MetadataSourceState $) {
    ...
    public static Builder builder(MetadataSourceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MetadataSourceState();
        }

        public Builder(MetadataSourceState defaults) {
            $ = new MetadataSourceState(Objects.requireNonNull(defaults));
        }

        /**
         * @param authentication Authentication details for AWS access.
         * 
         * @return builder
         * 
         */
        public Builder authentication(@Nullable Output<MetadataSourceAuthenticationArgs> authentication) {
         ...
         * 
         */
        public Builder authentication(MetadataSourceAuthenticationArgs authentication) {
        ...
        /**
         * @param contentType The content-type of the collected data. For Metadata source this is `AwsMetadata`. Details can be found in the [Sumologic documentation for hosted sources](https://help.sumologic.com/Send_Data/Sources/03Use_JSON_to_Configure_Sources/JSON_Parameters_for_Hosted_Sources).
         * 
         * @return builder
         * 
         */
        ...
        public Builder defaultDateFormats(@Nullable Output<List<MetadataSourceDefaultDateFormatArgs>> defaultDateFormats) {
            $.defaultDateFormats = defaultDateFormats;
            return this;
        }

        public Builder defaultDateFormats(List<MetadataSourceDefaultDateFormatArgs> defaultDateFormats) {
            return defaultDateFormats(Output.of(defaultDateFormats));
        }

        public Builder defaultDateFormats(MetadataSourceDefaultDateFormatArgs... defaultDateFormats) {
        ...
        public Builder filters(@Nullable Output<List<MetadataSourceFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<MetadataSourceFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(MetadataSourceFilterArgs... filters) {
         ...
         * 
         */
        public Builder path(@Nullable Output<MetadataSourcePathArgs> path) {
            $.path = path;
            return this;
        }
         ...
         * 
         */
        public Builder path(MetadataSourcePathArgs path) {
        ...
        public MetadataSourceState build() {
            return $;
        }
    }
