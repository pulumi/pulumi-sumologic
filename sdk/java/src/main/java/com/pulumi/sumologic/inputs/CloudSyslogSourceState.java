...
public final class CloudSyslogSourceState extends com.pulumi.resources.ResourceArgs {

    public static final CloudSyslogSourceState Empty = new CloudSyslogSourceState();
    ...
    private @Nullable Output<List<CloudSyslogSourceDefaultDateFormatArgs>> defaultDateFormats;

    public Optional<Output<List<CloudSyslogSourceDefaultDateFormatArgs>>> defaultDateFormats() {
    ...
    @Import(name="filters")
    private @Nullable Output<List<CloudSyslogSourceFilterArgs>> filters;

    public Optional<Output<List<CloudSyslogSourceFilterArgs>>> filters() {
    ...
    private CloudSyslogSourceState() {}

    private CloudSyslogSourceState(CloudSyslogSourceState $) {
    ...
    public static Builder builder(CloudSyslogSourceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudSyslogSourceState();
        }

        public Builder(CloudSyslogSourceState defaults) {
            $ = new CloudSyslogSourceState(Objects.requireNonNull(defaults));
        }
        ...
        public Builder defaultDateFormats(@Nullable Output<List<CloudSyslogSourceDefaultDateFormatArgs>> defaultDateFormats) {
            $.defaultDateFormats = defaultDateFormats;
            return this;
        }

        public Builder defaultDateFormats(List<CloudSyslogSourceDefaultDateFormatArgs> defaultDateFormats) {
            return defaultDateFormats(Output.of(defaultDateFormats));
        }

        public Builder defaultDateFormats(CloudSyslogSourceDefaultDateFormatArgs... defaultDateFormats) {
        ...
        public Builder filters(@Nullable Output<List<CloudSyslogSourceFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<CloudSyslogSourceFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(CloudSyslogSourceFilterArgs... filters) {
        ...
        public CloudSyslogSourceState build() {
            return $;
        }
    }
