...
public final class CseLogMappingFieldLookup {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("CseLogMappingFieldLookup", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("CseLogMappingFieldLookup", "value");
            }
            this.value = value;
            return this;
        }
        public CseLogMappingFieldLookup build() {
            final var _resultValue = new CseLogMappingFieldLookup();
