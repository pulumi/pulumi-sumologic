...
@CustomType
public final class KinesisLogSourceAuthentication {
    /**
    ...
    private KinesisLogSourceAuthentication() {}
    /**
     * @return Your AWS access key if using type `S3BucketAuthentication`
     * 
     */
    ...
    public static Builder builder(KinesisLogSourceAuthentication defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(KinesisLogSourceAuthentication defaults) {
        ...
        public KinesisLogSourceAuthentication build() {
            final var _resultValue = new KinesisLogSourceAuthentication();
