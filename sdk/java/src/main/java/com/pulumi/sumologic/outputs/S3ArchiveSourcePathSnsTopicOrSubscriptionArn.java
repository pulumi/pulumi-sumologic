...
@CustomType
public final class S3ArchiveSourcePathSnsTopicOrSubscriptionArn {
    private @Nullable String arn;
    private @Nullable Boolean isSuccess;

    private S3ArchiveSourcePathSnsTopicOrSubscriptionArn() {}
    ...
    public static Builder builder(S3ArchiveSourcePathSnsTopicOrSubscriptionArn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean isSuccess;
        public Builder() {}
        public Builder(S3ArchiveSourcePathSnsTopicOrSubscriptionArn defaults) {
