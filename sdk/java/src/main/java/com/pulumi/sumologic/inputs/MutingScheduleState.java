...
public final class MutingScheduleState extends com.pulumi.resources.ResourceArgs {

    public static final MutingScheduleState Empty = new MutingScheduleState();
    ...
    private @Nullable Output<MutingScheduleScheduleArgs> schedule;

    /**
     * @return Schedule definition. See `Schedule Definition` for more details.
     * 
     */
    public Optional<Output<MutingScheduleScheduleArgs>> schedule() {
    ...
    private MutingScheduleState() {}

    private MutingScheduleState(MutingScheduleState $) {
    ...
    public static Builder builder(MutingScheduleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MutingScheduleState();
        }

        public Builder(MutingScheduleState defaults) {
            $ = new MutingScheduleState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder schedule(@Nullable Output<MutingScheduleScheduleArgs> schedule) {
            $.schedule = schedule;
            return this;
        }
        ...
        public MutingScheduleState build() {
            return $;
        }
    }
