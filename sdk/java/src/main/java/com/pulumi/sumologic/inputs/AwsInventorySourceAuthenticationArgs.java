...
public final class AwsInventorySourceAuthenticationArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsInventorySourceAuthenticationArgs Empty = new AwsInventorySourceAuthenticationArgs();
    ...
    private AwsInventorySourceAuthenticationArgs() {}

    private AwsInventorySourceAuthenticationArgs(AwsInventorySourceAuthenticationArgs $) {
    ...
    public static Builder builder(AwsInventorySourceAuthenticationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsInventorySourceAuthenticationArgs();
        }

        public Builder(AwsInventorySourceAuthenticationArgs defaults) {
            $ = new AwsInventorySourceAuthenticationArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param roleArn Your AWS role ARN. More details [here](https://help.sumologic.com/03Send-Data/Sources/02Sources-for-Hosted-Collectors/Amazon-Web-Services/Grant-Access-to-an-AWS-Product#iam-role).
         * 
         * @return builder
         * 
         */
