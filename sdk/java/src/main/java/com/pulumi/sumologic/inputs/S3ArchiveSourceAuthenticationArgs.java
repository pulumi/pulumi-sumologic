...
public final class S3ArchiveSourceAuthenticationArgs extends com.pulumi.resources.ResourceArgs {

    public static final S3ArchiveSourceAuthenticationArgs Empty = new S3ArchiveSourceAuthenticationArgs();
    ...
    private S3ArchiveSourceAuthenticationArgs() {}

    private S3ArchiveSourceAuthenticationArgs(S3ArchiveSourceAuthenticationArgs $) {
    ...
    public static Builder builder(S3ArchiveSourceAuthenticationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new S3ArchiveSourceAuthenticationArgs();
        }

        public Builder(S3ArchiveSourceAuthenticationArgs defaults) {
            $ = new S3ArchiveSourceAuthenticationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public S3ArchiveSourceAuthenticationArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("S3ArchiveSourceAuthenticationArgs", "type");
            }
            return $;
        }
    }
