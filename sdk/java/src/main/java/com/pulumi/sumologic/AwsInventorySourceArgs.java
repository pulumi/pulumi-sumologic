...
public final class AwsInventorySourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AwsInventorySourceArgs build() {
            ...
            if ($.paused == null) {
                throw new MissingRequiredPropertyException("AwsInventorySourceArgs", "paused");
            }
            if ($.scanInterval == null) {
                throw new MissingRequiredPropertyException("AwsInventorySourceArgs", "scanInterval");
            }
            return $;
        }
    }
