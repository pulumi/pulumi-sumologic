...
@CustomType
public final class AwsXraySourceFilter {
    private String filterType;
    private @Nullable String mask;
    private String name;
    private String regexp;

    private AwsXraySourceFilter() {}
    ...
    public static Builder builder(AwsXraySourceFilter defaults) {
    ...
    public static final class Builder {
        ...
        private String regexp;
        public Builder() {}
        public Builder(AwsXraySourceFilter defaults) {
        ...
        public Builder filterType(String filterType) {
            if (filterType == null) {
              throw new MissingRequiredPropertyException("AwsXraySourceFilter", "filterType");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("AwsXraySourceFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder regexp(String regexp) {
            if (regexp == null) {
              throw new MissingRequiredPropertyException("AwsXraySourceFilter", "regexp");
            }
            this.regexp = regexp;
            return this;
        }
