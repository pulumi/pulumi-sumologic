...
public final class CseThresholdRuleEntitySelectorArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public CseThresholdRuleEntitySelectorArgs build() {
            if ($.entityType == null) {
                throw new MissingRequiredPropertyException("CseThresholdRuleEntitySelectorArgs", "entityType");
            }
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("CseThresholdRuleEntitySelectorArgs", "expression");
            }
            return $;
        }
    }
