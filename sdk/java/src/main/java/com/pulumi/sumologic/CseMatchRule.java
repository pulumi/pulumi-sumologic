...
public class CseMatchRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public CseMatchRule(java.lang.String name) {
     ...
     */
    public CseMatchRule(java.lang.String name, CseMatchRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CseMatchRule(java.lang.String name, CseMatchRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/cseMatchRule:CseMatchRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CseMatchRule(java.lang.String name, Output<java.lang.String> id, @Nullable CseMatchRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/cseMatchRule:CseMatchRule", name, state, makeResourceOptions(options, id), false);
    }

    private static CseMatchRuleArgs makeArgs(CseMatchRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CseMatchRuleArgs.Empty : args;
    }
     ...
     */
    public static CseMatchRule get(java.lang.String name, Output<java.lang.String> id, @Nullable CseMatchRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
