...
import com.pulumi.sumologic.inputs.AzureMetricsSourceAuthenticationArgs;
import com.pulumi.sumologic.inputs.AzureMetricsSourceDefaultDateFormatArgs;
import com.pulumi.sumologic.inputs.AzureMetricsSourceFilterArgs;
import com.pulumi.sumologic.inputs.AzureMetricsSourcePathArgs;
...
public final class AzureMetricsSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final AzureMetricsSourceArgs Empty = new AzureMetricsSourceArgs();
    ...
    private Output<AzureMetricsSourceAuthenticationArgs> authentication;

    /**
     * @return Authentication details for connecting to ingest metrics from Azure.
     * 
     */
    public Output<AzureMetricsSourceAuthenticationArgs> authentication() {
    ...
    private @Nullable Output<List<AzureMetricsSourceDefaultDateFormatArgs>> defaultDateFormats;

    public Optional<Output<List<AzureMetricsSourceDefaultDateFormatArgs>>> defaultDateFormats() {
    ...
    @Import(name="filters")
    private @Nullable Output<List<AzureMetricsSourceFilterArgs>> filters;

    public Optional<Output<List<AzureMetricsSourceFilterArgs>>> filters() {
    ...
    private Output<AzureMetricsSourcePathArgs> path;

    public Output<AzureMetricsSourcePathArgs> path() {
        return this.path;
    }
    ...
    private AzureMetricsSourceArgs() {}

    private AzureMetricsSourceArgs(AzureMetricsSourceArgs $) {
    ...
    public static Builder builder(AzureMetricsSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureMetricsSourceArgs();
        }

        public Builder(AzureMetricsSourceArgs defaults) {
            $ = new AzureMetricsSourceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder authentication(Output<AzureMetricsSourceAuthenticationArgs> authentication) {
        ...
        public Builder defaultDateFormats(@Nullable Output<List<AzureMetricsSourceDefaultDateFormatArgs>> defaultDateFormats) {
            $.defaultDateFormats = defaultDateFormats;
            return this;
        }

        public Builder defaultDateFormats(List<AzureMetricsSourceDefaultDateFormatArgs> defaultDateFormats) {
            return defaultDateFormats(Output.of(defaultDateFormats));
        }

        public Builder defaultDateFormats(AzureMetricsSourceDefaultDateFormatArgs... defaultDateFormats) {
        ...
        public Builder filters(@Nullable Output<List<AzureMetricsSourceFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<AzureMetricsSourceFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(AzureMetricsSourceFilterArgs... filters) {
        ...
        public Builder path(Output<AzureMetricsSourcePathArgs> path) {
            $.path = path;
            return this;
        }

        public Builder path(AzureMetricsSourcePathArgs path) {
        ...
        public AzureMetricsSourceArgs build() {
            if ($.authentication == null) {
                throw new MissingRequiredPropertyException("AzureMetricsSourceArgs", "authentication");
            }
            if ($.collectorId == null) {
                throw new MissingRequiredPropertyException("AzureMetricsSourceArgs", "collectorId");
            }
            if ($.contentType == null) {
                throw new MissingRequiredPropertyException("AzureMetricsSourceArgs", "contentType");
            }
            if ($.path == null) {
                throw new MissingRequiredPropertyException("AzureMetricsSourceArgs", "path");
            }
            return $;
        }
    }
