...
public class S3AuditSource extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="authentication", type=S3AuditSourceAuthentication.class, parameters={})
    ...
    @Export(name="defaultDateFormats", type=List.class, parameters={S3AuditSourceDefaultDateFormat.class})
    ...
    @Export(name="filters", type=List.class, parameters={S3AuditSourceFilter.class})
     ...
     * 
     */
    @Export(name="path", type=S3AuditSourcePath.class, parameters={})
    ...
    public S3AuditSource(String name, S3AuditSourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/s3AuditSource:S3AuditSource", name, args == null ? S3AuditSourceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
