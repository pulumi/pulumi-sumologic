...
public final class S3SourceAuthenticationArgs extends com.pulumi.resources.ResourceArgs {

    public static final S3SourceAuthenticationArgs Empty = new S3SourceAuthenticationArgs();
    ...
    private S3SourceAuthenticationArgs() {}

    private S3SourceAuthenticationArgs(S3SourceAuthenticationArgs $) {
    ...
    public static Builder builder(S3SourceAuthenticationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new S3SourceAuthenticationArgs();
        }

        public Builder(S3SourceAuthenticationArgs defaults) {
            $ = new S3SourceAuthenticationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public S3SourceAuthenticationArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("S3SourceAuthenticationArgs", "type");
            }
            return $;
        }
    }
