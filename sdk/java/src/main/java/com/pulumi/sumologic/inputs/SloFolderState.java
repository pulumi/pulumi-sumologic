...
public final class SloFolderState extends com.pulumi.resources.ResourceArgs {

    public static final SloFolderState Empty = new SloFolderState();
    ...
    private SloFolderState() {}

    private SloFolderState(SloFolderState $) {
    ...
    public static Builder builder(SloFolderState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SloFolderState defaults) {
            $ = new SloFolderState(Objects.requireNonNull(defaults));
        }
