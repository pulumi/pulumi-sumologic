...
@CustomType
public final class S3AuditSourceAuthentication {
    /**
    ...
    public static Builder builder(S3AuditSourceAuthentication defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(S3AuditSourceAuthentication defaults) {
        ...
        public Builder type(String type) {
            ...
            return this;
        }        public S3AuditSourceAuthentication build() {
            return new S3AuditSourceAuthentication(accessKey, authProviderX509CertUrl, authUri, clientEmail, clientId, clientX509CertUrl, privateKey, privateKeyId, projectId, region, roleArn, secretKey, tokenUri, type);
        }
    }
}
