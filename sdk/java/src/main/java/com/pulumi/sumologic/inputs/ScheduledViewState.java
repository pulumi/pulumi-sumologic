...
public final class ScheduledViewState extends com.pulumi.resources.ResourceArgs {

    public static final ScheduledViewState Empty = new ScheduledViewState();
    ...
    public static Builder builder(ScheduledViewState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ScheduledViewState();
        }

        public Builder(ScheduledViewState defaults) {
            $ = new ScheduledViewState(Objects.requireNonNull(defaults));
        }
        ...
        public ScheduledViewState build() {
            return $;
        }
    }
