...
public class AwsXraySource extends com.pulumi.resources.CustomResource {
     ...
     */
    public AwsXraySource(java.lang.String name) {
     ...
     */
    public AwsXraySource(java.lang.String name, AwsXraySourceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AwsXraySource(java.lang.String name, AwsXraySourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/awsXraySource:AwsXraySource", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AwsXraySource(java.lang.String name, Output<java.lang.String> id, @Nullable AwsXraySourceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/awsXraySource:AwsXraySource", name, state, makeResourceOptions(options, id), false);
    }

    private static AwsXraySourceArgs makeArgs(AwsXraySourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AwsXraySourceArgs.Empty : args;
    }
     ...
     */
    public static AwsXraySource get(java.lang.String name, Output<java.lang.String> id, @Nullable AwsXraySourceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
