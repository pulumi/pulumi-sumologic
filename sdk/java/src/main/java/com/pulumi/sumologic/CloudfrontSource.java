...
import com.pulumi.sumologic.inputs.CloudfrontSourceState;
import com.pulumi.sumologic.outputs.CloudfrontSourceAuthentication;
import com.pulumi.sumologic.outputs.CloudfrontSourceDefaultDateFormat;
import com.pulumi.sumologic.outputs.CloudfrontSourceFilter;
import com.pulumi.sumologic.outputs.CloudfrontSourcePath;
 ...
 * 
 */
@ResourceType(type="sumologic:index/cloudfrontSource:CloudfrontSource")
public class CloudfrontSource extends com.pulumi.resources.CustomResource {
    /**
     * Authentication details for connecting to the S3 bucket.
     * 
     */
    @Export(name="authentication", refs={CloudfrontSourceAuthentication.class}, tree="[0]")
    private Output<CloudfrontSourceAuthentication> authentication;

    /**
     * @return Authentication details for connecting to the S3 bucket.
     * 
     */
    public Output<CloudfrontSourceAuthentication> authentication() {
    ...
    @Export(name="defaultDateFormats", refs={List.class,CloudfrontSourceDefaultDateFormat.class}, tree="[0,1]")
    private Output</* @Nullable */ List<CloudfrontSourceDefaultDateFormat>> defaultDateFormats;

    public Output<Optional<List<CloudfrontSourceDefaultDateFormat>>> defaultDateFormats() {
    ...
    @Export(name="filters", refs={List.class,CloudfrontSourceFilter.class}, tree="[0,1]")
    private Output</* @Nullable */ List<CloudfrontSourceFilter>> filters;

    public Output<Optional<List<CloudfrontSourceFilter>>> filters() {
     ...
     * 
     */
    @Export(name="path", refs={CloudfrontSourcePath.class}, tree="[0]")
    private Output<CloudfrontSourcePath> path;

    /**
     * @return The location to scan for new data.
     * 
     */
    public Output<CloudfrontSourcePath> path() {
        return this.path;
    }
    /**
     ...
     */
    public CloudfrontSource(java.lang.String name) {
        this(name, CloudfrontSourceArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public CloudfrontSource(java.lang.String name, CloudfrontSourceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CloudfrontSource(java.lang.String name, CloudfrontSourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/cloudfrontSource:CloudfrontSource", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CloudfrontSource(java.lang.String name, Output<java.lang.String> id, @Nullable CloudfrontSourceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/cloudfrontSource:CloudfrontSource", name, state, makeResourceOptions(options, id), false);
    }

    private static CloudfrontSourceArgs makeArgs(CloudfrontSourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CloudfrontSourceArgs.Empty : args;
    }
     ...
     */
    public static CloudfrontSource get(java.lang.String name, Output<java.lang.String> id, @Nullable CloudfrontSourceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
