...
public class CloudfrontSource extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="authentication", type=CloudfrontSourceAuthentication.class, parameters={})
    ...
    @Export(name="defaultDateFormats", type=List.class, parameters={CloudfrontSourceDefaultDateFormat.class})
    ...
    @Export(name="filters", type=List.class, parameters={CloudfrontSourceFilter.class})
     ...
     * 
     */
    @Export(name="path", type=CloudfrontSourcePath.class, parameters={})
    ...
    public CloudfrontSource(String name, CloudfrontSourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/cloudfrontSource:CloudfrontSource", name, args == null ? CloudfrontSourceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
