...
public class MetricsSearch extends com.pulumi.resources.CustomResource {
     ...
     */
    public MetricsSearch(String name) {
     ...
     */
    public static MetricsSearch get(String name, Output<String> id, @Nullable MetricsSearchState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
