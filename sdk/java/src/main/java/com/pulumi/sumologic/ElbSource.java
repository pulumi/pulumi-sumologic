...
public class ElbSource extends com.pulumi.resources.CustomResource {
     ...
     */
    public ElbSource(java.lang.String name) {
     ...
     */
    public ElbSource(java.lang.String name, ElbSourceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ElbSource(java.lang.String name, ElbSourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/elbSource:ElbSource", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ElbSource(java.lang.String name, Output<java.lang.String> id, @Nullable ElbSourceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/elbSource:ElbSource", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ElbSource get(java.lang.String name, Output<java.lang.String> id, @Nullable ElbSourceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
