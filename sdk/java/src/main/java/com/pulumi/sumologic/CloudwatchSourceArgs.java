...
public final class CloudwatchSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<CloudwatchSourceAuthenticationArgs> authentication;

    /**
     * @return Authentication details for connecting to the S3 bucket.
     * 
     */
    public Output<CloudwatchSourceAuthenticationArgs> authentication() {
    ...
    private Output<CloudwatchSourcePathArgs> path;

    /**
     * @return The location to scan for new data.
     * 
     */
    public Output<CloudwatchSourcePathArgs> path() {
        return this.path;
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder authentication(Output<CloudwatchSourceAuthenticationArgs> authentication) {
         ...
         * 
         */
        public Builder path(Output<CloudwatchSourcePathArgs> path) {
            $.path = path;
            return this;
        }
        ...
        public CloudwatchSourceArgs build() {
            ...
            if ($.paused == null) {
                throw new MissingRequiredPropertyException("CloudwatchSourceArgs", "paused");
            }
            if ($.scanInterval == null) {
                throw new MissingRequiredPropertyException("CloudwatchSourceArgs", "scanInterval");
            }
            return $;
        }
    }
