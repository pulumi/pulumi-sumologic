...
import com.pulumi.sumologic.inputs.CloudtrailSourceDefaultDateFormatArgs;
import com.pulumi.sumologic.inputs.CloudtrailSourceFilterArgs;
...
public final class CloudtrailSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudtrailSourceArgs Empty = new CloudtrailSourceArgs();
    ...
    private Output<CloudtrailSourceAuthenticationArgs> authentication;

    /**
     * @return Authentication details for connecting to the S3 bucket.
     * 
     */
    public Output<CloudtrailSourceAuthenticationArgs> authentication() {
    ...
    private @Nullable Output<List<CloudtrailSourceDefaultDateFormatArgs>> defaultDateFormats;

    public Optional<Output<List<CloudtrailSourceDefaultDateFormatArgs>>> defaultDateFormats() {
    ...
    @Import(name="filters")
    private @Nullable Output<List<CloudtrailSourceFilterArgs>> filters;

    public Optional<Output<List<CloudtrailSourceFilterArgs>>> filters() {
    ...
    private Output<CloudtrailSourcePathArgs> path;

    /**
     * @return The location to scan for new data.
     * 
     */
    public Output<CloudtrailSourcePathArgs> path() {
        return this.path;
    }
    ...
    private CloudtrailSourceArgs() {}

    private CloudtrailSourceArgs(CloudtrailSourceArgs $) {
    ...
    public static Builder builder(CloudtrailSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudtrailSourceArgs();
        }

        public Builder(CloudtrailSourceArgs defaults) {
            $ = new CloudtrailSourceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder authentication(Output<CloudtrailSourceAuthenticationArgs> authentication) {
         ...
         * 
         */
        public Builder authentication(CloudtrailSourceAuthenticationArgs authentication) {
        ...
        public Builder defaultDateFormats(@Nullable Output<List<CloudtrailSourceDefaultDateFormatArgs>> defaultDateFormats) {
            $.defaultDateFormats = defaultDateFormats;
            return this;
        }

        public Builder defaultDateFormats(List<CloudtrailSourceDefaultDateFormatArgs> defaultDateFormats) {
            return defaultDateFormats(Output.of(defaultDateFormats));
        }

        public Builder defaultDateFormats(CloudtrailSourceDefaultDateFormatArgs... defaultDateFormats) {
        ...
        public Builder filters(@Nullable Output<List<CloudtrailSourceFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<CloudtrailSourceFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(CloudtrailSourceFilterArgs... filters) {
         ...
         * 
         */
        public Builder path(Output<CloudtrailSourcePathArgs> path) {
            $.path = path;
            return this;
        }
         ...
         * 
         */
        public Builder path(CloudtrailSourcePathArgs path) {
        ...
        public CloudtrailSourceArgs build() {
            if ($.authentication == null) {
                throw new MissingRequiredPropertyException("CloudtrailSourceArgs", "authentication");
            }
            if ($.collectorId == null) {
                throw new MissingRequiredPropertyException("CloudtrailSourceArgs", "collectorId");
            }
            if ($.contentType == null) {
                throw new MissingRequiredPropertyException("CloudtrailSourceArgs", "contentType");
            }
            if ($.path == null) {
                throw new MissingRequiredPropertyException("CloudtrailSourceArgs", "path");
            }
            if ($.paused == null) {
                throw new MissingRequiredPropertyException("CloudtrailSourceArgs", "paused");
            }
            if ($.scanInterval == null) {
                throw new MissingRequiredPropertyException("CloudtrailSourceArgs", "scanInterval");
            }
            return $;
        }
    }
