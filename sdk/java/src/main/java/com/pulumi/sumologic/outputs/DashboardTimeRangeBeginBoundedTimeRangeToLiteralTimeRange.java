...
public final class DashboardTimeRangeBeginBoundedTimeRangeToLiteralTimeRange {
    ...
    private DashboardTimeRangeBeginBoundedTimeRangeToLiteralTimeRange(@CustomType.Parameter("rangeName") String rangeName) {
    ...
    public static final class Builder {
        ...
        public Builder rangeName(String rangeName) {
            ...
            return new DashboardTimeRangeBeginBoundedTimeRangeToLiteralTimeRange(rangeName);
        }
    }
}
