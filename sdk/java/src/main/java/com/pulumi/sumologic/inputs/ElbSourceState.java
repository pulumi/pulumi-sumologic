...
public final class ElbSourceState extends com.pulumi.resources.ResourceArgs {

    public static final ElbSourceState Empty = new ElbSourceState();
    ...
    private @Nullable Output<ElbSourceAuthenticationArgs> authentication;

    /**
     * @return Authentication details for connecting to the S3 bucket.
     * 
     */
    public Optional<Output<ElbSourceAuthenticationArgs>> authentication() {
     ...
     */
    @Import(name="path")
    private @Nullable Output<ElbSourcePathArgs> path;

    /**
     * @return The location to scan for new data.
     * 
     */
    public Optional<Output<ElbSourcePathArgs>> path() {
    ...
    private ElbSourceState() {}

    private ElbSourceState(ElbSourceState $) {
    ...
    public static Builder builder(ElbSourceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ElbSourceState defaults) {
            $ = new ElbSourceState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder authentication(@Nullable Output<ElbSourceAuthenticationArgs> authentication) {
         ...
         * 
         */
        public Builder path(@Nullable Output<ElbSourcePathArgs> path) {
            $.path = path;
            return this;
        }
