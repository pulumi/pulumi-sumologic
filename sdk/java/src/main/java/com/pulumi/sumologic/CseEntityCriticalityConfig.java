...
public class CseEntityCriticalityConfig extends com.pulumi.resources.CustomResource {
     ...
     */
    public CseEntityCriticalityConfig(java.lang.String name) {
     ...
     */
    public CseEntityCriticalityConfig(java.lang.String name, CseEntityCriticalityConfigArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CseEntityCriticalityConfig(java.lang.String name, CseEntityCriticalityConfigArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/cseEntityCriticalityConfig:CseEntityCriticalityConfig", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CseEntityCriticalityConfig(java.lang.String name, Output<java.lang.String> id, @Nullable CseEntityCriticalityConfigState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/cseEntityCriticalityConfig:CseEntityCriticalityConfig", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static CseEntityCriticalityConfig get(java.lang.String name, Output<java.lang.String> id, @Nullable CseEntityCriticalityConfigState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
