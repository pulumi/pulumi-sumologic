...
public class CseAggregationRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public CseAggregationRule(java.lang.String name) {
     ...
     */
    public CseAggregationRule(java.lang.String name, CseAggregationRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CseAggregationRule(java.lang.String name, CseAggregationRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/cseAggregationRule:CseAggregationRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CseAggregationRule(java.lang.String name, Output<java.lang.String> id, @Nullable CseAggregationRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sumologic:index/cseAggregationRule:CseAggregationRule", name, state, makeResourceOptions(options, id), false);
    }

    private static CseAggregationRuleArgs makeArgs(CseAggregationRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CseAggregationRuleArgs.Empty : args;
    }
     ...
     */
    public static CseAggregationRule get(java.lang.String name, Output<java.lang.String> id, @Nullable CseAggregationRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
