...
public final class S3ArchiveSourceState extends com.pulumi.resources.ResourceArgs {

    public static final S3ArchiveSourceState Empty = new S3ArchiveSourceState();
    ...
    private @Nullable Output<S3ArchiveSourceAuthenticationArgs> authentication;

    /**
     * @return Authentication details for connecting to the S3 bucket.
     * 
     */
    public Optional<Output<S3ArchiveSourceAuthenticationArgs>> authentication() {
     ...
     */
    @Import(name="path")
    private @Nullable Output<S3ArchiveSourcePathArgs> path;

    /**
     * @return The location to scan for new data.
     * 
     */
    public Optional<Output<S3ArchiveSourcePathArgs>> path() {
    ...
    private S3ArchiveSourceState() {}

    private S3ArchiveSourceState(S3ArchiveSourceState $) {
    ...
    public static Builder builder(S3ArchiveSourceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new S3ArchiveSourceState();
        }

        public Builder(S3ArchiveSourceState defaults) {
            $ = new S3ArchiveSourceState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder authentication(@Nullable Output<S3ArchiveSourceAuthenticationArgs> authentication) {
         ...
         * 
         */
        public Builder path(@Nullable Output<S3ArchiveSourcePathArgs> path) {
            $.path = path;
            return this;
        }
        ...
        public S3ArchiveSourceState build() {
            return $;
        }
    }
