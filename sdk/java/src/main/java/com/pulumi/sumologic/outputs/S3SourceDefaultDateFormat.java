...
@CustomType
public final class S3SourceDefaultDateFormat {
    ...
    public static Builder builder(S3SourceDefaultDateFormat defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(S3SourceDefaultDateFormat defaults) {
        ...
        public Builder locator(@Nullable String locator) {
            ...
            return new S3SourceDefaultDateFormat(format, locator);
        }
    }
}
