...
class RoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] capabilities: List of capabilities associated with this role. For a complete list of capability names, please see `capabilities` field in the request of [CreateRole](https://api.sumologic.com/docs/#operation/createRole) endpoint.
               
               The following attributes are exported:
        :param pulumi.Input[builtins.str] description: The description of the role.
        :param pulumi.Input[builtins.str] filter_predicate: A search filter to restrict access to specific logs.
...
@pulumi.type_token("sumologic:index/role:Role")
class Role(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="filterPredicate")
    def filter_predicate(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A search filter to restrict access to specific logs.
        """
        return pulumi.get(self, "filter_predicate")
