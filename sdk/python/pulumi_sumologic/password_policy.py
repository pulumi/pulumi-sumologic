...
class PasswordPolicyArgs:
    def __init__(__self__, *,
                 account_lockout_duration_in_mins: Optional[pulumi.Input[builtins.int]] = None,
                 account_lockout_threshold: Optional[pulumi.Input[builtins.int]] = None,
                 failed_login_reset_duration_in_mins: Optional[pulumi.Input[builtins.int]] = None,
                 max_length: Optional[pulumi.Input[builtins.int]] = None,
                 max_password_age_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 min_length: Optional[pulumi.Input[builtins.int]] = None,
                 min_unique_passwords: Optional[pulumi.Input[builtins.int]] = None,
                 must_contain_digits: Optional[pulumi.Input[builtins.bool]] = None,
                 must_contain_lowercase: Optional[pulumi.Input[builtins.bool]] = None,
                 must_contain_special_chars: Optional[pulumi.Input[builtins.bool]] = None,
                 must_contain_uppercase: Optional[pulumi.Input[builtins.bool]] = None,
                 remember_mfa: Optional[pulumi.Input[builtins.bool]] = None,
                 require_mfa: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a PasswordPolicy resource.
        :param pulumi.Input[builtins.int] account_lockout_duration_in_mins: The duration of time in minutes that a locked-out account remained locked before getting unlocked automatically. Defaults to 30.
        :param pulumi.Input[builtins.int] account_lockout_threshold: Number of failed login attempts allowed before account is locked-out. Defaults to 6.
        :param pulumi.Input[builtins.int] failed_login_reset_duration_in_mins: The duration of time in minutes that must elapse from the first failed login attempt after which failed login count is reset to 0. Defaults to 10.
        :param pulumi.Input[builtins.int] max_length: The maximum length of the password. Defaults to 128. (128 is now the only accepted value; other values are no longer supported, and this field may be deprecated in the future.)
        :param pulumi.Input[builtins.int] max_password_age_in_days: Maximum number of days that a password can be used before user is required to change it. Put -1 if the user should not have to change their password. Defaults to 365.
        :param pulumi.Input[builtins.int] min_length: The minimum length of the password. Defaults to 8.
        :param pulumi.Input[builtins.int] min_unique_passwords: The minimum number of unique new passwords that a user must use before an old password can be reused. Defaults to 10.
        :param pulumi.Input[builtins.bool] must_contain_digits: If the password must contain digits. Defaults to true.
        :param pulumi.Input[builtins.bool] must_contain_lowercase: If the password must contain lower case characters. Defaults to true.
        :param pulumi.Input[builtins.bool] must_contain_special_chars: If the password must contain special characters. Defaults to true.
        :param pulumi.Input[builtins.bool] must_contain_uppercase: If the password must contain upper case characters. Defaults to true.
        :param pulumi.Input[builtins.bool] remember_mfa: If MFA should be remembered on the browser. Defaults to true.
               
               [1]: https://help.sumologic.com/Manage/Security/Set-the-Password-Policy
        :param pulumi.Input[builtins.bool] require_mfa: If MFA should be required to log in. Defaults to false.
        """
    ...
    def account_lockout_duration_in_mins(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def account_lockout_duration_in_mins(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "account_lockout_duration_in_mins", value)

    @property
    @pulumi.getter(name="accountLockoutThreshold")
    def account_lockout_threshold(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def account_lockout_threshold(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "account_lockout_threshold", value)

    @property
    @pulumi.getter(name="failedLoginResetDurationInMins")
    def failed_login_reset_duration_in_mins(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def failed_login_reset_duration_in_mins(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def max_password_age_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_password_age_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def min_unique_passwords(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def min_unique_passwords(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "min_unique_passwords", value)

    @property
    @pulumi.getter(name="mustContainDigits")
    def must_contain_digits(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def must_contain_digits(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "must_contain_digits", value)

    @property
    @pulumi.getter(name="mustContainLowercase")
    def must_contain_lowercase(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def must_contain_lowercase(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "must_contain_lowercase", value)

    @property
    @pulumi.getter(name="mustContainSpecialChars")
    def must_contain_special_chars(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def must_contain_special_chars(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "must_contain_special_chars", value)

    @property
    @pulumi.getter(name="mustContainUppercase")
    def must_contain_uppercase(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def must_contain_uppercase(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "must_contain_uppercase", value)

    @property
    @pulumi.getter(name="rememberMfa")
    def remember_mfa(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @remember_mfa.setter
    def remember_mfa(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "remember_mfa", value)

    @property
    @pulumi.getter(name="requireMfa")
    def require_mfa(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @require_mfa.setter
    def require_mfa(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class PasswordPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            must_contain_uppercase: Optional[pulumi.Input[builtins.bool]] = None,
            remember_mfa: Optional[pulumi.Input[builtins.bool]] = None,
            require_mfa: Optional[pulumi.Input[builtins.bool]] = None) -> 'PasswordPolicy':
        """
    ...
    @property
    @pulumi.getter(name="accountLockoutDurationInMins")
    def account_lockout_duration_in_mins(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The duration of time in minutes that a locked-out account remained locked before getting unlocked automatically. Defaults to 30.
        """
        return pulumi.get(self, "account_lockout_duration_in_mins")
    ...
    @property
    @pulumi.getter(name="accountLockoutThreshold")
    def account_lockout_threshold(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of failed login attempts allowed before account is locked-out. Defaults to 6.
        """
        return pulumi.get(self, "account_lockout_threshold")
    ...
    @property
    @pulumi.getter(name="failedLoginResetDurationInMins")
    def failed_login_reset_duration_in_mins(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The duration of time in minutes that must elapse from the first failed login attempt after which failed login count is reset to 0. Defaults to 10.
        """
        return pulumi.get(self, "failed_login_reset_duration_in_mins")
    ...
    @property
    @pulumi.getter(name="maxPasswordAgeInDays")
    def max_password_age_in_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum number of days that a password can be used before user is required to change it. Put -1 if the user should not have to change their password. Defaults to 365.
        """
        return pulumi.get(self, "max_password_age_in_days")
    ...
    @property
    @pulumi.getter(name="minUniquePasswords")
    def min_unique_passwords(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The minimum number of unique new passwords that a user must use before an old password can be reused. Defaults to 10.
        """
        return pulumi.get(self, "min_unique_passwords")
    ...
    @property
    @pulumi.getter(name="mustContainDigits")
    def must_contain_digits(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If the password must contain digits. Defaults to true.
        """
        return pulumi.get(self, "must_contain_digits")
    ...
    @property
    @pulumi.getter(name="mustContainLowercase")
    def must_contain_lowercase(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If the password must contain lower case characters. Defaults to true.
        """
        return pulumi.get(self, "must_contain_lowercase")
    ...
    @property
    @pulumi.getter(name="mustContainSpecialChars")
    def must_contain_special_chars(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If the password must contain special characters. Defaults to true.
        """
        return pulumi.get(self, "must_contain_special_chars")
    ...
    @property
    @pulumi.getter(name="mustContainUppercase")
    def must_contain_uppercase(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If the password must contain upper case characters. Defaults to true.
        """
        return pulumi.get(self, "must_contain_uppercase")
    ...
    @property
    @pulumi.getter(name="rememberMfa")
    def remember_mfa(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If MFA should be remembered on the browser. Defaults to true.
    ...
    @property
    @pulumi.getter(name="requireMfa")
    def require_mfa(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If MFA should be required to log in. Defaults to false.
        """
        return pulumi.get(self, "require_mfa")
