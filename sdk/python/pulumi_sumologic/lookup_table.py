...
class LookupTableArgs:
    def __init__(__self__, *,
                 ...
                 size_limit_action: Optional[pulumi.Input[builtins.str]] = None,
                 ttl: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a LookupTable resource.
        :param pulumi.Input[builtins.str] description: The description of the lookup table.
        ...
        :param pulumi.Input[builtins.str] name: The name of the lookup table.
        :param pulumi.Input[builtins.str] parent_folder_id: The parent-folder-path identifier of the lookup table in the Library.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] primary_keys: The primary key field names.
        :param pulumi.Input[builtins.int] ttl: A time to live for each entry in the lookup table (in minutes). 365 days is the maximum time to live for each entry that you can specify. Setting it to 0 means that the records will not expire automatically.
    ...
    def size_limit_action(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "size_limit_action")

    @size_limit_action.setter
    def size_limit_action(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("sumologic:index/lookupTable:LookupTable")
class LookupTable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            primary_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            size_limit_action: Optional[pulumi.Input[builtins.str]] = None,
            ttl: Optional[pulumi.Input[builtins.int]] = None) -> 'LookupTable':
        """
    ...
    @property
    @pulumi.getter(name="primaryKeys")
    def primary_keys(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The primary key field names.
        """
        return pulumi.get(self, "primary_keys")
    ...
    @property
    @pulumi.getter(name="sizeLimitAction")
    def size_limit_action(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "size_limit_action")
