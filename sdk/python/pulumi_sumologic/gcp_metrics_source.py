...
class GcpMetricsSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            authentication = _utilities.configure(authentication, GcpMetricsSourceAuthenticationArgs, True)
            ...
            path = _utilities.configure(path, GcpMetricsSourcePathArgs, True)
