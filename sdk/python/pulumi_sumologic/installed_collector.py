...
class InstalledCollectorArgs:
    def __init__(__self__, *,
                 ...
                 source_sync_mode: Optional[pulumi.Input[builtins.str]] = None,
                 target_cpu: Optional[pulumi.Input[builtins.int]] = None,
                 timezone: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a InstalledCollector resource.
        :param pulumi.Input[builtins.bool] ephemeral: When true, the collector will be deleted after 12 hours of inactivity. For more information, see [Setting a Collector as Ephemeral][5].
        ...
        :param pulumi.Input[builtins.str] description: The description of the collector.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] fields: Map containing [key/value pairs][3].
        :param pulumi.Input[builtins.str] host_name: Host name of the Collector. The hostname can be a maximum of 128 characters.
        :param pulumi.Input[builtins.str] name: The name of the collector. This is required, and has to be unique. Changing this will force recreation the collector.
        :param pulumi.Input[builtins.str] source_sync_mode: For installed Collectors, whether the Collector is using local source configuration management (using a JSON file), or cloud management (using the UI)
        :param pulumi.Input[builtins.int] target_cpu: When CPU utilization exceeds this threshold, the Collector will slow down its rate of ingestion to lower its CPU utilization. Currently only Local and Remote File Sources are supported.
        :param pulumi.Input[builtins.str] timezone: The time zone to use for this collector. The value follows the [tzdata](https://en.wikipedia.org/wiki/Tz_database) naming convention.
        """
    ...
    def source_sync_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_sync_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_sync_mode", value)

    @property
    @pulumi.getter(name="targetCpu")
    def target_cpu(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @target_cpu.setter
    def target_cpu(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _InstalledCollectorState:
    def __init__(__self__, *,
                 ...
                 category: Optional[pulumi.Input[builtins.str]] = None,
                 collector_version: Optional[pulumi.Input[builtins.str]] = None,
                 cutoff_timestamp: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 ephemeral: Optional[pulumi.Input[builtins.bool]] = None,
                 fields: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 host_name: Optional[pulumi.Input[builtins.str]] = None,
                 last_seen_alive: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 source_sync_mode: Optional[pulumi.Input[builtins.str]] = None,
                 target_cpu: Optional[pulumi.Input[builtins.int]] = None,
                 timezone: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def collector_version(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "collector_version")

    @collector_version.setter
    def collector_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def last_seen_alive(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "last_seen_alive")

    @last_seen_alive.setter
    def last_seen_alive(self, value: Optional[pulumi.Input[builtins.int]]):
...
class InstalledCollector(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_sync_mode: Optional[pulumi.Input[builtins.str]] = None,
            target_cpu: Optional[pulumi.Input[builtins.int]] = None,
            timezone: Optional[pulumi.Input[builtins.str]] = None) -> 'InstalledCollector':
        """
    ...
    @property
    @pulumi.getter(name="collectorVersion")
    def collector_version(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "collector_version")
    ...
    @property
    @pulumi.getter
    def ephemeral(self) -> pulumi.Output[builtins.bool]:
        """
        When true, the collector will be deleted after 12 hours of inactivity. For more information, see [Setting a Collector as Ephemeral][5].
        """
        return pulumi.get(self, "ephemeral")
    ...
    @property
    @pulumi.getter(name="lastSeenAlive")
    def last_seen_alive(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "last_seen_alive")
    ...
    @property
    @pulumi.getter(name="sourceSyncMode")
    def source_sync_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        For installed Collectors, whether the Collector is using local source configuration management (using a JSON file), or cloud management (using the UI)
        """
        return pulumi.get(self, "source_sync_mode")
    ...
    @property
    @pulumi.getter(name="targetCpu")
    def target_cpu(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        When CPU utilization exceeds this threshold, the Collector will slow down its rate of ingestion to lower its CPU utilization. Currently only Local and Remote File Sources are supported.
        """
        return pulumi.get(self, "target_cpu")
