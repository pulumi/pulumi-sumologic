...
class ConnectionArgs:
    def __init__(__self__, *,
                 default_payload: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str],
                 url: pulumi.Input[builtins.str],
                 connection_subtype: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 resolution_payload: Optional[pulumi.Input[builtins.str]] = None,
                 webhook_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Connection resource.
        :param pulumi.Input[builtins.str] default_payload: Default payload of the webhook.
        :param pulumi.Input[builtins.str] type: Type of connection. Only `WebhookConnection` is implemented right now.
        :param pulumi.Input[builtins.str] url: URL for the webhook connection.
        :param pulumi.Input[builtins.str] connection_subtype: The subtype of the connection. Valid values are `Incident` and `Event`. NOTE: This is only used for the `ServiceNow` webhook type.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] custom_headers: Map of custom webhook headers
        :param pulumi.Input[builtins.str] description: Description of the connection.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] headers: Map of access authorization headers.
        :param pulumi.Input[builtins.str] name: Name of connection. Name should be a valid alphanumeric value.
        :param pulumi.Input[builtins.str] resolution_payload: Resolution payload of the webhook.
        :param pulumi.Input[builtins.str] webhook_type: Type of webhook. Valid values are `AWSLambda`, `Azure`, `Datadog`, `HipChat`, `Jira`, `PagerDuty`, `Slack`, `Webhook`, `NewRelic`, `MicrosoftTeams`, `ServiceNow`, and `SumoCloudSOAR`. Default: `Webhook`
    ...
    def default_payload(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def default_payload(self, value: pulumi.Input[builtins.str]):
    ...
    def connection_subtype(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connection_subtype(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def resolution_payload(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resolution_payload(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ConnectionState:
    def __init__(__self__, *,
                 connection_subtype: Optional[pulumi.Input[builtins.str]] = None,
                 custom_headers: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 default_payload: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 headers: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 resolution_payload: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="defaultPayload")
    def default_payload(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Default payload of the webhook.
        """
        return pulumi.get(self, "default_payload")
    ...
    @default_payload.setter
    def default_payload(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_payload", value)
...
class Connection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            webhook_type: Optional[pulumi.Input[builtins.str]] = None) -> 'Connection':
        """
    ...
    @property
    @pulumi.getter(name="connectionSubtype")
    def connection_subtype(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The subtype of the connection. Valid values are `Incident` and `Event`. NOTE: This is only used for the `ServiceNow` webhook type.
        """
        return pulumi.get(self, "connection_subtype")
    ...
    @property
    @pulumi.getter(name="defaultPayload")
    def default_payload(self) -> pulumi.Output[builtins.str]:
        """
        Default payload of the webhook.
        """
        return pulumi.get(self, "default_payload")
    ...
    @property
    @pulumi.getter(name="resolutionPayload")
    def resolution_payload(self) -> pulumi.Output[builtins.str]:
        """
        Resolution payload of the webhook.
        """
        return pulumi.get(self, "resolution_payload")
    ...
    @property
    @pulumi.getter(name="webhookType")
    def webhook_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Type of webhook. Valid values are `AWSLambda`, `Azure`, `Datadog`, `HipChat`, `Jira`, `PagerDuty`, `Slack`, `Webhook`, `NewRelic`, `MicrosoftTeams`, `ServiceNow`, and `SumoCloudSOAR`. Default: `Webhook`
