...
class CseAggregationRuleArgs:
    def __init__(__self__, *,
                 ...
                 trigger_expression: pulumi.Input[builtins.str],
                 window_size: pulumi.Input[builtins.str],
                 group_by_entity: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 window_size_millis: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] trigger_expression: The expression to determine whether a Signal should be created based on the aggregation results
        :param pulumi.Input[builtins.str] window_size: How long of a window to aggregate records for. Current acceptable values are T05M, T10M, T30M, T60M, T24H, T12H, T05D or CUSTOM
        :param pulumi.Input[builtins.bool] group_by_entity: Whether to group records by the specified entity fields
    ...
    def trigger_expression(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def trigger_expression(self, value: pulumi.Input[builtins.str]):
    ...
    def group_by_entity(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def group_by_entity(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def window_size_millis(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "window_size_millis")

    @window_size_millis.setter
    def window_size_millis(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CseAggregationRuleState:
    def __init__(__self__, *,
                 ...
                 suppression_window_size: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 trigger_expression: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="triggerExpression")
    def trigger_expression(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The expression to determine whether a Signal should be created based on the aggregation results
        """
        return pulumi.get(self, "trigger_expression")
    ...
    @trigger_expression.setter
    def trigger_expression(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "trigger_expression", value)
...
class CseAggregationRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            trigger_expression: Optional[pulumi.Input[builtins.str]] = None,
            window_size: Optional[pulumi.Input[builtins.str]] = None,
            window_size_millis: Optional[pulumi.Input[builtins.str]] = None) -> 'CseAggregationRule':
        """
    ...
    @property
    @pulumi.getter(name="groupByEntity")
    def group_by_entity(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to group records by the specified entity fields
        """
        return pulumi.get(self, "group_by_entity")
    ...
    @property
    @pulumi.getter(name="triggerExpression")
    def trigger_expression(self) -> pulumi.Output[builtins.str]:
        """
        The expression to determine whether a Signal should be created based on the aggregation results
        """
        return pulumi.get(self, "trigger_expression")
    ...
    @property
    @pulumi.getter(name="windowSizeMillis")
    def window_size_millis(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "window_size_millis")
