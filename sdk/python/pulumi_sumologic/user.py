...
class UserArgs:
    def __init__(__self__, *,
                 ...
                 transfer_to: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a User resource.
        :param pulumi.Input[builtins.str] email: Email of the user.
        :param pulumi.Input[builtins.str] first_name: First name of the user.
        :param pulumi.Input[builtins.bool] is_active: This has the value true if the user is active and false if they have been deactivated.
        :param pulumi.Input[builtins.str] last_name: Last name of the user.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] role_ids: List of roleIds associated with the user.
        :param pulumi.Input[builtins.str] transfer_to: UserId of user to transfer this user's content to on deletion, can be empty. Must be applied prior to deletion to take effect.
    ...
    def transfer_to(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @transfer_to.setter
    def transfer_to(self, value: pulumi.Input[builtins.str]):
...
class _UserState:
    def __init__(__self__, *,
                 ...
                 transfer_to: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="transferTo")
    def transfer_to(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        UserId of user to transfer this user's content to on deletion, can be empty. Must be applied prior to deletion to take effect.
    ...
    @transfer_to.setter
    def transfer_to(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "transfer_to", value)
...
class User(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            last_name: Optional[pulumi.Input[builtins.str]] = None,
            role_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            transfer_to: Optional[pulumi.Input[builtins.str]] = None) -> 'User':
        """
    ...
    @property
    @pulumi.getter(name="transferTo")
    def transfer_to(self) -> pulumi.Output[builtins.str]:
        """
        UserId of user to transfer this user's content to on deletion, can be empty. Must be applied prior to deletion to take effect.
