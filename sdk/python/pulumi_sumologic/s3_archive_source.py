...
@pulumi.type_token("sumologic:index/s3ArchiveSource:S3ArchiveSource")
class S3ArchiveSource(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 authentication: Optional[pulumi.Input[Union['S3ArchiveSourceAuthenticationArgs', 'S3ArchiveSourceAuthenticationArgsDict']]] = None,
                 automatic_date_parsing: Optional[pulumi.Input[builtins.bool]] = None,
                 category: Optional[pulumi.Input[builtins.str]] = None,
                 collector_id: Optional[pulumi.Input[builtins.int]] = None,
                 content_type: Optional[pulumi.Input[builtins.str]] = None,
                 cutoff_relative_time: Optional[pulumi.Input[builtins.str]] = None,
                 cutoff_timestamp: Optional[pulumi.Input[builtins.int]] = None,
                 default_date_formats: Optional[pulumi.Input[Sequence[pulumi.Input[Union['S3ArchiveSourceDefaultDateFormatArgs', 'S3ArchiveSourceDefaultDateFormatArgsDict']]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 fields: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 filters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['S3ArchiveSourceFilterArgs', 'S3ArchiveSourceFilterArgsDict']]]]] = None,
                 force_timezone: Optional[pulumi.Input[builtins.bool]] = None,
                 hash_algorithm: Optional[pulumi.Input[builtins.str]] = None,
                 host_name: Optional[pulumi.Input[builtins.str]] = None,
                 manual_prefix_regexp: Optional[pulumi.Input[builtins.str]] = None,
                 multiline_processing_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 path: Optional[pulumi.Input[Union['S3ArchiveSourcePathArgs', 'S3ArchiveSourcePathArgsDict']]] = None,
                 paused: Optional[pulumi.Input[builtins.bool]] = None,
                 scan_interval: Optional[pulumi.Input[builtins.int]] = None,
                 timezone: Optional[pulumi.Input[builtins.str]] = None,
                 use_autoline_matching: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Union['S3ArchiveSourceAuthenticationArgs', 'S3ArchiveSourceAuthenticationArgsDict']] authentication: Authentication details for connecting to the S3 bucket.
        :param pulumi.Input[builtins.str] content_type: The content-type of the collected data. It should be `AwsS3ArchiveBucket` for archive source. Details can be found in the [Sumologic documentation for hosted sources](https://help.sumologic.com/Send_Data/Sources/03Use_JSON_to_Configure_Sources/JSON_Parameters_for_Hosted_Sources).
        :param pulumi.Input[Union['S3ArchiveSourcePathArgs', 'S3ArchiveSourcePathArgsDict']] path: The location to scan for new data.
        :param pulumi.Input[builtins.bool] paused: When set to true, the scanner is paused. To disable, set to false.
        :param pulumi.Input[builtins.int] scan_interval: Time interval in milliseconds of scans for new data. The default is 300000 and the minimum value is 1000 milliseconds.
        """
        ...
    ...
    def get(resource_name: str,
            ...
            timezone: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            use_autoline_matching: Optional[pulumi.Input[builtins.bool]] = None) -> 'S3ArchiveSource':
        """
