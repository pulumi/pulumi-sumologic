...
class MetricsSearchArgs:
    def __init__(__self__, *,
                 ...
                 desired_quantization_in_secs: Optional[pulumi.Input[builtins.int]] = None,
                 log_query: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a MetricsSearch resource.
        :param pulumi.Input[builtins.str] description: Description of the search.
        ...
        :param pulumi.Input[builtins.str] parent_id: The identifier of the folder to create the log search in.
        :param pulumi.Input['MetricsSearchTimeRangeArgs'] time_range: Time range of the log search. See time range schema
        :param pulumi.Input[builtins.str] title: Title of the search.
        :param pulumi.Input[builtins.int] desired_quantization_in_secs: Desired quantization in seconds. Default value is `0`.
        :param pulumi.Input[builtins.str] log_query: Log query used to add an overlay to the chart.
        """
    ...
    def desired_quantization_in_secs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def desired_quantization_in_secs(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "desired_quantization_in_secs", value)

    @property
    @pulumi.getter(name="logQuery")
    def log_query(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @log_query.setter
    def log_query(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MetricsSearch(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            parent_id: Optional[pulumi.Input[builtins.str]] = None,
            time_range: Optional[pulumi.Input[Union['MetricsSearchTimeRangeArgs', 'MetricsSearchTimeRangeArgsDict']]] = None,
            title: Optional[pulumi.Input[builtins.str]] = None) -> 'MetricsSearch':
        """
    ...
    @property
    @pulumi.getter(name="desiredQuantizationInSecs")
    def desired_quantization_in_secs(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Desired quantization in seconds. Default value is `0`.
        """
        return pulumi.get(self, "desired_quantization_in_secs")
    ...
    @property
    @pulumi.getter(name="logQuery")
    def log_query(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Log query used to add an overlay to the chart.
        """
        return pulumi.get(self, "log_query")
