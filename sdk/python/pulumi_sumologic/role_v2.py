...
class RoleV2Args:
    def __init__(__self__, *,
                 audit_data_filter: Optional[pulumi.Input[builtins.str]] = None,
                 capabilities: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 log_analytics_filter: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 security_data_filter: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] audit_data_filter: A search filter which would be applied on partitions which belong to Audit Data product area. Help Doc : (https://help.sumologic.com/docs/manage/security/audit-index/).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] capabilities: List of [capabilities](https://help.sumologic.com/docs/manage/users-roles/roles/role-capabilities/) associated with this role.
        :param pulumi.Input[builtins.str] description: Description of the role.
        :param pulumi.Input[builtins.str] log_analytics_filter: A search filter which would be applied on partitions which belong to Log Analytics product area.
        :param pulumi.Input[builtins.str] name: Name of the role.
        :param pulumi.Input[builtins.str] security_data_filter: A search filter which would be applied on partitions which belong to Security Data product area.
        ...
        :param pulumi.Input[builtins.str] selection_type: Describes the Permission Construct for the list of views in "selectedViews" parameter.
        """
    ...
    def audit_data_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def audit_data_filter(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def log_analytics_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def log_analytics_filter(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def security_data_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def security_data_filter(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RoleV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            security_data_filter: Optional[pulumi.Input[builtins.str]] = None,
            selected_views: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RoleV2SelectedViewArgs', 'RoleV2SelectedViewArgsDict']]]]] = None,
            selection_type: Optional[pulumi.Input[builtins.str]] = None) -> 'RoleV2':
        """
    ...
    @property
    @pulumi.getter(name="auditDataFilter")
    def audit_data_filter(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A search filter which would be applied on partitions which belong to Audit Data product area. Help Doc : (https://help.sumologic.com/docs/manage/security/audit-index/).
        """
        return pulumi.get(self, "audit_data_filter")
    ...
    @property
    @pulumi.getter(name="logAnalyticsFilter")
    def log_analytics_filter(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A search filter which would be applied on partitions which belong to Log Analytics product area.
        """
        return pulumi.get(self, "log_analytics_filter")
    ...
    @property
    @pulumi.getter(name="securityDataFilter")
    def security_data_filter(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A search filter which would be applied on partitions which belong to Security Data product area.
        """
        return pulumi.get(self, "security_data_filter")
    ...
    @property
    @pulumi.getter(name="selectionType")
    def selection_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Describes the Permission Construct for the list of views in "selectedViews" parameter.
        """
        return pulumi.get(self, "selection_type")
