...
class GetCollectorResult:
    ...
    @property
    @pulumi.getter
    def fields(self) -> Mapping[str, builtins.str]:
...
def get_collector(id: Optional[builtins.int] = None,
...
def get_collector_output(id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
