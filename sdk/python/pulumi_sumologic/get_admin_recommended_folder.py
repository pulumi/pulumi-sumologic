...
def get_admin_recommended_folder(description: Optional[builtins.str] = None,
...
def get_admin_recommended_folder_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
