...
class CseInventoryEntityGroupConfigurationArgs:
    def __init__(__self__, *,
                 inventory_source: pulumi.Input[builtins.str],
                 inventory_type: pulumi.Input[builtins.str],
                 criticality: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 dynamic_tags: Optional[pulumi.Input[builtins.bool]] = None,
                 group: Optional[pulumi.Input[builtins.str]] = None,
                 inventory_key: Optional[pulumi.Input[builtins.str]] = None,
                 inventory_value: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 suppressed: Optional[pulumi.Input[builtins.bool]] = None,
                 tag_schema: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a CseInventoryEntityGroupConfiguration resource.
        :param pulumi.Input[builtins.str] inventory_source: The inventory source Examples: "Active Directory", "Okta".
        :param pulumi.Input[builtins.str] inventory_type: The inventory type Examples: "computer", "username".
        :param pulumi.Input[builtins.str] criticality: The entity group configuration criticality Examples: "HIGH", "CRITICALITY".
        :param pulumi.Input[builtins.str] description: The entity group configuration description.
        :param pulumi.Input[builtins.bool] dynamic_tags: If dynamic tags are enabled for configuration.
        :param pulumi.Input[builtins.str] group: (Deprecated) The entity group configuration inventory group. The field `group` is deprecated and will be removed in a future release of the provider -- please make usage of `inventory_key`, `inventory_value`  instead.
        :param pulumi.Input[builtins.str] inventory_key: The inventory key to apply configuration Examples: "groups", "normalizedHostname", "normalizedComputerName".
        :param pulumi.Input[builtins.str] inventory_value: The inventory value to match.
        :param pulumi.Input[builtins.str] name: The entity group configuration name.
        :param pulumi.Input[builtins.str] tag_schema: The tag schema to be used for dynamic tags.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The entity group configuration tags list.
    ...
    def inventory_source(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def inventory_source(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "inventory_source", value)

    @property
    @pulumi.getter(name="inventoryType")
    def inventory_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def inventory_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "inventory_type", value)

    @property
    @pulumi.getter
    def criticality(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @criticality.setter
    def criticality(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def dynamic_tags(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @dynamic_tags.setter
    def dynamic_tags(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def inventory_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inventory_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "inventory_key", value)

    @property
    @pulumi.getter(name="inventoryValue")
    def inventory_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inventory_value(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def suppressed(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "suppressed")

    @suppressed.setter
    def suppressed(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "suppressed", value)

    @property
    @pulumi.getter(name="tagSchema")
    def tag_schema(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @tag_schema.setter
    def tag_schema(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CseInventoryEntityGroupConfigurationState:
    def __init__(__self__, *,
                 ...
                 group: Optional[pulumi.Input[builtins.str]] = None,
                 inventory_key: Optional[pulumi.Input[builtins.str]] = None,
                 inventory_source: Optional[pulumi.Input[builtins.str]] = None,
                 inventory_type: Optional[pulumi.Input[builtins.str]] = None,
                 inventory_value: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 suppressed: Optional[pulumi.Input[builtins.bool]] = None,
                 tag_schema: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="inventorySource")
    def inventory_source(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The inventory source Examples: "Active Directory", "Okta".
        """
        return pulumi.get(self, "inventory_source")
    ...
    @inventory_source.setter
    def inventory_source(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "inventory_source", value)

    @property
    @pulumi.getter(name="inventoryType")
    def inventory_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The inventory type Examples: "computer", "username".
        """
        return pulumi.get(self, "inventory_type")
    ...
    @inventory_type.setter
    def inventory_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "inventory_type", value)
...
class CseInventoryEntityGroupConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            suppressed: Optional[pulumi.Input[builtins.bool]] = None,
            tag_schema: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'CseInventoryEntityGroupConfiguration':
        """
    ...
    @property
    @pulumi.getter
    def criticality(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The entity group configuration criticality Examples: "HIGH", "CRITICALITY".
        """
        return pulumi.get(self, "criticality")
    ...
    @property
    @pulumi.getter(name="dynamicTags")
    def dynamic_tags(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If dynamic tags are enabled for configuration.
        """
        return pulumi.get(self, "dynamic_tags")
    ...
    @property
    @pulumi.getter(name="inventoryKey")
    def inventory_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The inventory key to apply configuration Examples: "groups", "normalizedHostname", "normalizedComputerName".
        """
        return pulumi.get(self, "inventory_key")
    ...
    @property
    @pulumi.getter(name="inventorySource")
    def inventory_source(self) -> pulumi.Output[builtins.str]:
        """
        The inventory source Examples: "Active Directory", "Okta".
        """
        return pulumi.get(self, "inventory_source")
    ...
    @property
    @pulumi.getter(name="inventoryValue")
    def inventory_value(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The inventory value to match.
        """
        return pulumi.get(self, "inventory_value")
    ...
    @property
    @pulumi.getter
    def suppressed(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "suppressed")

    @property
    @pulumi.getter(name="tagSchema")
    def tag_schema(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The tag schema to be used for dynamic tags.
        """
        return pulumi.get(self, "tag_schema")
