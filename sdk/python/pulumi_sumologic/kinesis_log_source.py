...
class _KinesisLogSourceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content_type: The content-type of the collected data. Details can be found in the [Sumologic documentation for hosted sources](https://help.sumologic.com/Send_Data/Sources/03Use_JSON_to_Configure_Sources/JSON_Parameters_for_Hosted_Sources).
        :param pulumi.Input['KinesisLogSourcePathArgs'] path: The location of S3 bucket for failed Kinesis log data.
        :param pulumi.Input[builtins.str] url: The HTTP endpoint to be used while creating Kinesis Firehose on AWS.
        """
        if authentication is not None:
            pulumi.set(__self__, "authentication", authentication)
        if automatic_date_parsing is not None:
...
class KinesisLogSource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            timezone: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            use_autoline_matching: Optional[pulumi.Input[builtins.bool]] = None) -> 'KinesisLogSource':
        """
