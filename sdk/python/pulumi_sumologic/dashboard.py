...
class DashboardArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain: Domain of the dashboard. If set denotes that the dashboard concerns a given domain.
        :param pulumi.Input[builtins.str] folder_id: The identifier of the folder to save the dashboard in. By default it is saved in your
               personal folder.
        ...
        :param pulumi.Input[builtins.int] refresh_interval: Interval of time (in seconds) to automatically refresh the dashboard. Valid values are 120,300,900,1800,3600,7200,86400.
        :param pulumi.Input[builtins.str] theme: Theme of the dashboard.
...
@pulumi.type_token("sumologic:index/dashboard:Dashboard")
