...
class _AwsXraySourceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] scan_interval: Time interval in milliseconds of scans for new data. The minimum value is 1000 milliseconds. Currently this value is not respected, and collection happens at a default interval of 1 minute.
        """
        _AwsXraySourceState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            authentication=authentication,
            automatic_date_parsing=automatic_date_parsing,
            category=category,
...
class AwsXraySource(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AwsXraySourceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if authentication is not None and not isinstance(authentication, AwsXraySourceAuthenticationArgs):
                authentication = authentication or {}
                def _setter(key, value):
                    authentication[key] = value
                AwsXraySourceAuthenticationArgs._configure(_setter, **authentication)
            ...
            if path is not None and not isinstance(path, AwsXraySourcePathArgs):
                path = path or {}
                def _setter(key, value):
                    path[key] = value
                AwsXraySourcePathArgs._configure(_setter, **path)
    ...
    def get(resource_name: str,
            ...
            timezone: Optional[pulumi.Input[str]] = None,
            url: Optional[pulumi.Input[str]] = None,
            use_autoline_matching: Optional[pulumi.Input[bool]] = None) -> 'AwsXraySource':
        """
