...
__all__ = ['AwsXraySourceArgs', 'AwsXraySource']

@pulumi.input_type
class AwsXraySourceArgs:
    def __init__(__self__, *,
                 authentication: pulumi.Input['AwsXraySourceAuthenticationArgs'],
                 collector_id: pulumi.Input[builtins.int],
                 content_type: pulumi.Input[builtins.str],
                 path: pulumi.Input['AwsXraySourcePathArgs'],
                 ...
                 default_date_formats: Optional[pulumi.Input[Sequence[pulumi.Input['AwsXraySourceDefaultDateFormatArgs']]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 fields: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 filters: Optional[pulumi.Input[Sequence[pulumi.Input['AwsXraySourceFilterArgs']]]] = None,
        ...
        :param pulumi.Input[builtins.str] content_type: The content-type of the collected data. This has to be `AwsXRay` for AWS XRay source.
        ...
        :param pulumi.Input[builtins.int] scan_interval: Time interval in milliseconds of scans for new data. The minimum value is 1000 milliseconds. Currently this value is not respected, and collection happens at a default interval of 1 minute.
        """
    ...
    def authentication(self, value: pulumi.Input['AwsXraySourceAuthenticationArgs']):
    ...
    @path.setter
    def path(self, value: pulumi.Input['AwsXraySourcePathArgs']):
    ...
    def default_date_formats(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['AwsXraySourceDefaultDateFormatArgs']]]]:
        return pulumi.get(self, "default_date_formats")

    @default_date_formats.setter
    def default_date_formats(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['AwsXraySourceDefaultDateFormatArgs']]]]):
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['AwsXraySourceFilterArgs']]]]:
        return pulumi.get(self, "filters")

    @filters.setter
    def filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['AwsXraySourceFilterArgs']]]]):
...
@pulumi.input_type
class _AwsXraySourceState:
    def __init__(__self__, *,
                 authentication: Optional[pulumi.Input['AwsXraySourceAuthenticationArgs']] = None,
                 automatic_date_parsing: Optional[pulumi.Input[builtins.bool]] = None,
                 category: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 multiline_processing_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 path: Optional[pulumi.Input['AwsXraySourcePathArgs']] = None,
                 paused: Optional[pulumi.Input[builtins.bool]] = None,
                 scan_interval: Optional[pulumi.Input[builtins.int]] = None,
                 timezone: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @authentication.setter
    def authentication(self, value: Optional[pulumi.Input['AwsXraySourceAuthenticationArgs']]):
        pulumi.set(self, "authentication", value)
    ...
    @path.setter
    def path(self, value: Optional[pulumi.Input['AwsXraySourcePathArgs']]):
        pulumi.set(self, "path", value)
...
class AwsXraySource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param AwsXraySourceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AwsXraySourceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AwsXraySourceArgs.__new__(AwsXraySourceArgs)
        ...
        super(AwsXraySource, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            timezone: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            use_autoline_matching: Optional[pulumi.Input[builtins.bool]] = None) -> 'AwsXraySource':
        """
        ...
        __props__ = _AwsXraySourceState.__new__(_AwsXraySourceState)
        ...
        __props__.__dict__["use_autoline_matching"] = use_autoline_matching
        return AwsXraySource(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="defaultDateFormats")
    def default_date_formats(self) -> pulumi.Output[Optional[Sequence['outputs.AwsXraySourceDefaultDateFormat']]]:
        return pulumi.get(self, "default_date_formats")
    ...
    @property
    @pulumi.getter
    def filters(self) -> pulumi.Output[Optional[Sequence['outputs.AwsXraySourceFilter']]]:
        return pulumi.get(self, "filters")
