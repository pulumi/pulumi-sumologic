...
class CloudtrailSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            authentication = _utilities.configure(authentication, CloudtrailSourceAuthenticationArgs, True)
            ...
            path = _utilities.configure(path, CloudtrailSourcePathArgs, True)
