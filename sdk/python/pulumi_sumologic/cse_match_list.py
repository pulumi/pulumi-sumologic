...
class CseMatchListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Match list description.
        :param pulumi.Input[builtins.str] target_column: Target column. (possible values: Hostname, FileHash, Url, SrcIp, DstIp, Domain, Username, Ip, Asn, Isp, Org, SrcAsn, SrcIsp, SrcOrg, DstAsn, DstIsp, DstOrg or any custom column.)
        :param pulumi.Input[builtins.int] default_ttl: The default time to live for match list items added through the UI. Specified in seconds.
        :param pulumi.Input[builtins.str] name: Match list name.
        """
...
class CseMatchList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            last_updated_by: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            target_column: Optional[pulumi.Input[builtins.str]] = None) -> 'CseMatchList':
        """
    ...
    @property
    @pulumi.getter(name="targetColumn")
    def target_column(self) -> pulumi.Output[builtins.str]:
        """
        Target column. (possible values: Hostname, FileHash, Url, SrcIp, DstIp, Domain, Username, Ip, Asn, Isp, Org, SrcAsn, SrcIsp, SrcOrg, DstAsn, DstIsp, DstOrg or any custom column.)
        """
        return pulumi.get(self, "target_column")
