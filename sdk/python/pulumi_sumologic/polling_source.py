...
class PollingSourceArgs:
    def __init__(__self__, *,
                 ...
                 scan_interval: pulumi.Input[builtins.int],
    ...
    def scan_interval(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def scan_interval(self, value: pulumi.Input[builtins.int]):
...
class PollingSource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            timezone: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            use_autoline_matching: Optional[pulumi.Input[builtins.bool]] = None) -> 'PollingSource':
        """
    ...
    @property
    @pulumi.getter(name="scanInterval")
    def scan_interval(self) -> pulumi.Output[builtins.int]:
        """
        Time interval in milliseconds of scans for new data. The default is 300000 and the minimum value is 1000 milliseconds.
        """
        return pulumi.get(self, "scan_interval")
