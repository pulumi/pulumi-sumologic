...
class _PollingSourceState:
    def __init__(__self__, *,
        ...
        """
        _PollingSourceState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            authentication=authentication,
            automatic_date_parsing=automatic_date_parsing,
            category=category,
...
class PollingSource(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PollingSourceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if authentication is not None and not isinstance(authentication, PollingSourceAuthenticationArgs):
                authentication = authentication or {}
                def _setter(key, value):
                    authentication[key] = value
                PollingSourceAuthenticationArgs._configure(_setter, **authentication)
            ...
            if path is not None and not isinstance(path, PollingSourcePathArgs):
                path = path or {}
                def _setter(key, value):
                    path[key] = value
                PollingSourcePathArgs._configure(_setter, **path)
