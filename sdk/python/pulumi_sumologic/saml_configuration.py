...
class SamlConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 x509cert1: pulumi.Input[builtins.str],
                 authn_request_url: Optional[pulumi.Input[builtins.str]] = None,
                 debug_mode: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_requested_authn_context: Optional[pulumi.Input[builtins.bool]] = None,
                 email_attribute: Optional[pulumi.Input[builtins.str]] = None,
                 is_redirect_binding: Optional[pulumi.Input[builtins.bool]] = None,
                 logout_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 roles_attribute: Optional[pulumi.Input[builtins.str]] = None,
                 sign_authn_request: Optional[pulumi.Input[builtins.bool]] = None,
                 sp_initiated_login_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 sp_initiated_login_path: Optional[pulumi.Input[builtins.str]] = None,
                 x509cert2: Optional[pulumi.Input[builtins.str]] = None,
                 x509cert3: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SamlConfiguration resource.
        :param pulumi.Input[builtins.str] configuration_name: Name of the SSO policy or another name used to describe the policy internally.
        :param pulumi.Input[builtins.str] issuer: The unique URL assigned to the organization by the SAML Identity Provider.
        :param pulumi.Input[builtins.str] x509cert1: The certificate is used to verify the signature in SAML assertions.
        :param pulumi.Input[builtins.str] authn_request_url: The URL that the identity provider has assigned for Sumo Logic to submit SAML authentication requests to the identity provider. Defaults to "".
        :param pulumi.Input[builtins.bool] debug_mode: True if additional details are included when a user fails to sign in. Defaults to false.
        :param pulumi.Input[builtins.bool] disable_requested_authn_context: True if Sumo Logic will include the RequestedAuthnContext element of the SAML AuthnRequests it sends to the identity provider. Defaults to false.
        :param pulumi.Input[builtins.str] email_attribute: The email address of the new user account. Defaults to "".
        :param pulumi.Input[builtins.bool] is_redirect_binding: True if the SAML binding is of HTTP Redirect type. Defaults to false.
        :param pulumi.Input[builtins.bool] logout_enabled: True if users are redirected to a URL after signing out of Sumo Logic. Defaults to false.
        :param pulumi.Input[builtins.str] logout_url: The URL that users will be redirected to after signing out of Sumo Logic. Defaults to "".
        ...
        :param pulumi.Input[builtins.str] roles_attribute: The role that Sumo Logic will assign to users when they sign in. Defaults to "".
        :param pulumi.Input[builtins.bool] sign_authn_request: True if Sumo Logic will send signed Authn requests to the identity provider. Defaults to false.
        :param pulumi.Input[builtins.bool] sp_initiated_login_enabled: True if Sumo Logic redirects users to your identity provider with a SAML AuthnRequest when signing in. Defaults to false.
        :param pulumi.Input[builtins.str] sp_initiated_login_path: The identifier used to generate a unique URL for user login. Defaults to "".
        :param pulumi.Input[builtins.str] x509cert2: The backup certificate used to verify the signature in SAML assertions when x509cert1 expires. Defaults to "".
        :param pulumi.Input[builtins.str] x509cert3: The backup certificate used to verify the signature in SAML assertions when x509cert1 expires and x509cert2 is empty. Defaults to "".
        """
    ...
    @property
    @pulumi.getter
    def x509cert1(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @x509cert1.setter
    def x509cert1(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "x509cert1", value)

    @property
    @pulumi.getter(name="authnRequestUrl")
    def authn_request_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def authn_request_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authn_request_url", value)

    @property
    @pulumi.getter(name="debugMode")
    def debug_mode(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @debug_mode.setter
    def debug_mode(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "debug_mode", value)

    @property
    @pulumi.getter(name="disableRequestedAuthnContext")
    def disable_requested_authn_context(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_requested_authn_context(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def is_redirect_binding(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_redirect_binding(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_redirect_binding", value)

    @property
    @pulumi.getter(name="logoutEnabled")
    def logout_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def logout_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def roles_attribute(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def roles_attribute(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "roles_attribute", value)

    @property
    @pulumi.getter(name="signAuthnRequest")
    def sign_authn_request(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def sign_authn_request(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "sign_authn_request", value)

    @property
    @pulumi.getter(name="spInitiatedLoginEnabled")
    def sp_initiated_login_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def sp_initiated_login_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "sp_initiated_login_enabled", value)

    @property
    @pulumi.getter(name="spInitiatedLoginPath")
    def sp_initiated_login_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sp_initiated_login_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sp_initiated_login_path", value)

    @property
    @pulumi.getter
    def x509cert2(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @x509cert2.setter
    def x509cert2(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "x509cert2", value)

    @property
    @pulumi.getter
    def x509cert3(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @x509cert3.setter
    def x509cert3(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SamlConfigurationState:
    def __init__(__self__, *,
                 assertion_consumer_url: Optional[pulumi.Input[builtins.str]] = None,
                 authn_request_url: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 sp_initiated_login_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 sp_initiated_login_path: Optional[pulumi.Input[builtins.str]] = None,
                 x509cert1: Optional[pulumi.Input[builtins.str]] = None,
                 x509cert2: Optional[pulumi.Input[builtins.str]] = None,
                 x509cert3: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def assertion_consumer_url(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "assertion_consumer_url")

    @assertion_consumer_url.setter
    def assertion_consumer_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def x509cert1(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The certificate is used to verify the signature in SAML assertions.
        """
        return pulumi.get(self, "x509cert1")
    ...
    @x509cert1.setter
    def x509cert1(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "x509cert1", value)
...
class SamlConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            x509cert1: Optional[pulumi.Input[builtins.str]] = None,
            x509cert2: Optional[pulumi.Input[builtins.str]] = None,
            x509cert3: Optional[pulumi.Input[builtins.str]] = None) -> 'SamlConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="assertionConsumerUrl")
    def assertion_consumer_url(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "assertion_consumer_url")

    @property
    @pulumi.getter(name="authnRequestUrl")
    def authn_request_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL that the identity provider has assigned for Sumo Logic to submit SAML authentication requests to the identity provider. Defaults to "".
        """
        return pulumi.get(self, "authn_request_url")
    ...
    @property
    @pulumi.getter(name="debugMode")
    def debug_mode(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        True if additional details are included when a user fails to sign in. Defaults to false.
        """
        return pulumi.get(self, "debug_mode")
    ...
    @property
    @pulumi.getter(name="disableRequestedAuthnContext")
    def disable_requested_authn_context(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        True if Sumo Logic will include the RequestedAuthnContext element of the SAML AuthnRequests it sends to the identity provider. Defaults to false.
        """
        return pulumi.get(self, "disable_requested_authn_context")
    ...
    @property
    @pulumi.getter(name="isRedirectBinding")
    def is_redirect_binding(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        True if the SAML binding is of HTTP Redirect type. Defaults to false.
        """
        return pulumi.get(self, "is_redirect_binding")
    ...
    @property
    @pulumi.getter(name="logoutEnabled")
    def logout_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        True if users are redirected to a URL after signing out of Sumo Logic. Defaults to false.
        """
        return pulumi.get(self, "logout_enabled")
    ...
    @property
    @pulumi.getter(name="rolesAttribute")
    def roles_attribute(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The role that Sumo Logic will assign to users when they sign in. Defaults to "".
        """
        return pulumi.get(self, "roles_attribute")
    ...
    @property
    @pulumi.getter(name="signAuthnRequest")
    def sign_authn_request(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        True if Sumo Logic will send signed Authn requests to the identity provider. Defaults to false.
        """
        return pulumi.get(self, "sign_authn_request")
    ...
    @property
    @pulumi.getter(name="spInitiatedLoginEnabled")
    def sp_initiated_login_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        True if Sumo Logic redirects users to your identity provider with a SAML AuthnRequest when signing in. Defaults to false.
        """
        return pulumi.get(self, "sp_initiated_login_enabled")
    ...
    @property
    @pulumi.getter(name="spInitiatedLoginPath")
    def sp_initiated_login_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The identifier used to generate a unique URL for user login. Defaults to "".
        """
        return pulumi.get(self, "sp_initiated_login_path")
    ...
    @property
    @pulumi.getter
    def x509cert1(self) -> pulumi.Output[builtins.str]:
        """
        The certificate is used to verify the signature in SAML assertions.
        """
        return pulumi.get(self, "x509cert1")
    ...
    @property
    @pulumi.getter
    def x509cert2(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The backup certificate used to verify the signature in SAML assertions when x509cert1 expires. Defaults to "".
        """
        return pulumi.get(self, "x509cert2")
    ...
    @property
    @pulumi.getter
    def x509cert3(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The backup certificate used to verify the signature in SAML assertions when x509cert1 expires and x509cert2 is empty. Defaults to "".
        """
        return pulumi.get(self, "x509cert3")
