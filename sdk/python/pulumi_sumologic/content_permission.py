...
class ContentPermissionArgs:
    def __init__(__self__, *,
                 ...
                 notify_recipient: pulumi.Input[builtins.bool],
                 permissions: pulumi.Input[Sequence[pulumi.Input['ContentPermissionPermissionArgs']]],
                 notification_message: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ContentPermission resource.
        :param pulumi.Input[builtins.str] content_id: The identifier of the content item for which you want to update
               permissions.
        :param pulumi.Input[builtins.bool] notify_recipient: Boolean value. Set it to "true" to notify the recipients by email.
        ...
        :param pulumi.Input[builtins.str] notification_message: The notification message to send to the users.
        """
    ...
    def notify_recipient(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def notify_recipient(self, value: pulumi.Input[builtins.bool]):
    ...
    def notification_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def notification_message(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ContentPermissionState:
    def __init__(__self__, *,
                 ...
                 notification_message: Optional[pulumi.Input[builtins.str]] = None,
                 notify_recipient: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="notifyRecipient")
    def notify_recipient(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Boolean value. Set it to "true" to notify the recipients by email.
        """
        return pulumi.get(self, "notify_recipient")
    ...
    @notify_recipient.setter
    def notify_recipient(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "notify_recipient", value)
...
class ContentPermission(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="notificationMessage")
    def notification_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The notification message to send to the users.
        """
        return pulumi.get(self, "notification_message")
    ...
    @property
    @pulumi.getter(name="notifyRecipient")
    def notify_recipient(self) -> pulumi.Output[builtins.bool]:
        """
        Boolean value. Set it to "true" to notify the recipients by email.
        """
        return pulumi.get(self, "notify_recipient")
