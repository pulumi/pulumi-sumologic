...
class MetricsSearchV2Args:
    def __init__(__self__, *,
                 ...
                 visual_settings: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] folder_id: The identifier of the folder to create the metrics search in.
        """
    ...
    def visual_settings(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "visual_settings")

    @visual_settings.setter
    def visual_settings(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("sumologic:index/metricsSearchV2:MetricsSearchV2")
class MetricsSearchV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_range: Optional[pulumi.Input[Union['MetricsSearchV2TimeRangeArgs', 'MetricsSearchV2TimeRangeArgsDict']]] = None,
            title: Optional[pulumi.Input[builtins.str]] = None,
            visual_settings: Optional[pulumi.Input[builtins.str]] = None) -> 'MetricsSearchV2':
        """
    ...
    @property
    @pulumi.getter(name="visualSettings")
    def visual_settings(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "visual_settings")
