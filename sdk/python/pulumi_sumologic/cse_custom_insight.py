...
class CseCustomInsightArgs:
    def __init__(__self__, *,
                 ...
                 ordered: pulumi.Input[builtins.bool],
                 ...
                 signal_match_strategy: Optional[pulumi.Input[builtins.str]] = None,
                 signal_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a CseCustomInsight resource.
        :param pulumi.Input[builtins.str] description: The description of the generated Insights
        :param pulumi.Input[builtins.bool] enabled: Whether the Custom Insight should generate Insights
        :param pulumi.Input[builtins.bool] ordered: Whether the signals matching the rule IDs/signal names must be in the same chronological order as they are listed in the Custom Insight
        :param pulumi.Input[builtins.str] severity: The severity of the generated Insights (CRITICAL, HIGH, MEDIUM, or LOW)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags of the generated Insights
        ...
        :param pulumi.Input[builtins.str] name: The name of the Custom Insight and the generated Insights
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] rule_ids: The Rule IDs to match to generate an Insight (exactly one of rule_ids or signal_names must be specified)
        :param pulumi.Input[builtins.str] signal_match_strategy: The signal match strategy to use when generating insights (ENTITY, STRICT)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] signal_names: The Signal names to match to generate an Insight (exactly one of rule_ids or signal_names must be specified)
        """
    ...
    @property
    @pulumi.getter
    def ordered(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @ordered.setter
    def ordered(self, value: pulumi.Input[builtins.bool]):
    ...
    def signal_match_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def signal_match_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "signal_match_strategy", value)

    @property
    @pulumi.getter(name="signalNames")
    def signal_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @signal_names.setter
    def signal_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class CseCustomInsight(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 dynamic_severities: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CseCustomInsightDynamicSeverityArgs', 'CseCustomInsightDynamicSeverityArgsDict']]]]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 ordered: Optional[pulumi.Input[builtins.bool]] = None,
                 rule_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The description of the generated Insights
        :param pulumi.Input[Sequence[pulumi.Input[Union['CseCustomInsightDynamicSeverityArgs', 'CseCustomInsightDynamicSeverityArgsDict']]]] dynamic_severities: The severity of the generated Insight that is based on the severity of the Signals that trigger the Insight.
        :param pulumi.Input[builtins.bool] enabled: Whether the Custom Insight should generate Insights
        :param pulumi.Input[builtins.str] name: The name of the Custom Insight and the generated Insights
        :param pulumi.Input[builtins.bool] ordered: Whether the signals matching the rule IDs/signal names must be in the same chronological order as they are listed in the Custom Insight
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] rule_ids: The Rule IDs to match to generate an Insight (exactly one of rule_ids or signal_names must be specified)
    ...
    def get(resource_name: str,
            ...
            signal_match_strategy: Optional[pulumi.Input[builtins.str]] = None,
            signal_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'CseCustomInsight':
        """
    ...
    @property
    @pulumi.getter
    def ordered(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the signals matching the rule IDs/signal names must be in the same chronological order as they are listed in the Custom Insight
        """
        return pulumi.get(self, "ordered")
    ...
    @property
    @pulumi.getter(name="signalMatchStrategy")
    def signal_match_strategy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The signal match strategy to use when generating insights (ENTITY, STRICT)
        """
        return pulumi.get(self, "signal_match_strategy")
    ...
    @property
    @pulumi.getter(name="signalNames")
    def signal_names(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The Signal names to match to generate an Insight (exactly one of rule_ids or signal_names must be specified)
        """
        return pulumi.get(self, "signal_names")
