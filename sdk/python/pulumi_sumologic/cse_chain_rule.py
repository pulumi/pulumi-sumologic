...
class CseChainRuleArgs:
    def __init__(__self__, *,
                 ...
                 ordered: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] ordered: Whether the records matching the expressions must be in the same chronological order as the expressions are listed in the rule
    ...
    @property
    @pulumi.getter
    def ordered(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @ordered.setter
    def ordered(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class CseChainRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            window_size: Optional[pulumi.Input[builtins.str]] = None,
            window_size_millis: Optional[pulumi.Input[builtins.str]] = None) -> 'CseChainRule':
        """
    ...
    @property
    @pulumi.getter
    def ordered(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the records matching the expressions must be in the same chronological order as the expressions are listed in the rule
        """
        return pulumi.get(self, "ordered")
