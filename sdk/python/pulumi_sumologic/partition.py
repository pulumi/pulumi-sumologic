...
class PartitionArgs:
    def __init__(__self__, *,
                 analytics_tier: Optional[pulumi.Input[builtins.str]] = None,
                 is_compliant: Optional[pulumi.Input[builtins.bool]] = None,
                 is_included_in_default_search: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.int] retention_period: The number of days to retain data in the partition, or -1 to use the default value for your account. Only relevant if your account has variable retention enabled.
        :param pulumi.Input[builtins.str] routing_expression: The query that defines the data to be included in the partition.
        """
    ...
    def analytics_tier(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_included_in_default_search(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_included_in_default_search(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def routing_expression(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def routing_expression(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PartitionState:
    ...
    def total_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "total_bytes")

    @total_bytes.setter
    def total_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Partition(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retention_period: Optional[pulumi.Input[builtins.int]] = None,
            routing_expression: Optional[pulumi.Input[builtins.str]] = None,
            total_bytes: Optional[pulumi.Input[builtins.int]] = None) -> 'Partition':
        """
    ...
    @property
    @pulumi.getter(name="dataForwardingId")
    def data_forwarding_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "data_forwarding_id")
    ...
    @property
    @pulumi.getter(name="isCompliant")
    def is_compliant(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the partition is compliant or not. Mark a partition as compliant if it contains data used for compliance or audit purpose. Retention for a compliant partition can only be increased and cannot be reduced after the partition is marked compliant. A partition once marked compliant, cannot be marked non-compliant later.
        """
        return pulumi.get(self, "is_compliant")
    ...
    @property
    @pulumi.getter(name="isIncludedInDefaultSearch")
    def is_included_in_default_search(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the partition is included in the default search scope. When executing a query such as "error | count," certain partitions are automatically part of the search scope. However, for specific partitions, the user must explicitly mention the partition using the _index term, as in "_index=webApp error | count". This property governs the default inclusion of the partition in the search scope. Configuring this property is exclusively permitted for flex partitions.
        """
        return pulumi.get(self, "is_included_in_default_search")
    ...
    @property
    @pulumi.getter(name="routingExpression")
    def routing_expression(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The query that defines the data to be included in the partition.
        """
        return pulumi.get(self, "routing_expression")
    ...
    @property
    @pulumi.getter(name="totalBytes")
    def total_bytes(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "total_bytes")
