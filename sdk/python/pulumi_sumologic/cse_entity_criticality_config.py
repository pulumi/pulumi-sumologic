...
class CseEntityCriticalityConfigArgs:
    def __init__(__self__, *,
                 severity_expression: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a CseEntityCriticalityConfig resource.
        :param pulumi.Input[builtins.str] severity_expression: Algebraic expression representing this entity\\'s criticality. Examples: "severity * 2", "severity - 5", "severity / 3".
               
               
               The following attributes are exported:
        :param pulumi.Input[builtins.str] name: Human friendly and unique name. Examples: "Executive Laptop", "Bastion Host".
        """
    ...
    def severity_expression(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def severity_expression(self, value: pulumi.Input[builtins.str]):
...
class _CseEntityCriticalityConfigState:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 severity_expression: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="severityExpression")
    def severity_expression(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Algebraic expression representing this entity\\'s criticality. Examples: "severity * 2", "severity - 5", "severity / 3".
    ...
    @severity_expression.setter
    def severity_expression(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "severity_expression", value)


@pulumi.type_token("sumologic:index/cseEntityCriticalityConfig:CseEntityCriticalityConfig")
class CseEntityCriticalityConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            severity_expression: Optional[pulumi.Input[builtins.str]] = None) -> 'CseEntityCriticalityConfig':
        """
    ...
    @property
    @pulumi.getter(name="severityExpression")
    def severity_expression(self) -> pulumi.Output[builtins.str]:
        """
        Algebraic expression representing this entity\\'s criticality. Examples: "severity * 2", "severity - 5", "severity / 3".
