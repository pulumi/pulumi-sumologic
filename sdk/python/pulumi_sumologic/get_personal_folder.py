...
def get_personal_folder(description: Optional[builtins.str] = None,
...
def get_personal_folder_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
