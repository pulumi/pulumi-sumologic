...
class LogSearchArgs:
    def __init__(__self__, *,
                 ...
                 run_by_receipt_time: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] query_string: Log query to perform.
        ...
        :param pulumi.Input[builtins.str] name: Name of the search.
        :param pulumi.Input[builtins.str] parsing_mode: Define the parsing mode to scan the JSON format log messages. Possible values are:
        ...
        :param pulumi.Input[builtins.bool] run_by_receipt_time: This has the value `true` if the search is to be run by receipt time and
    ...
    def run_by_receipt_time(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def run_by_receipt_time(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("sumologic:index/logSearch:LogSearch")
class LogSearch(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="runByReceiptTime")
    def run_by_receipt_time(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        This has the value `true` if the search is to be run by receipt time and
        `false` if it is to be run by message time. Default value is `false`.
        """
