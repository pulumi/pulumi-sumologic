...
class HierarchyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the hierarchy.
        """
...
@pulumi.type_token("sumologic:index/hierarchy:Hierarchy")
class Hierarchy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            filter: Optional[pulumi.Input[Union['HierarchyFilterArgs', 'HierarchyFilterArgsDict']]] = None,
            levels: Optional[pulumi.Input[Sequence[pulumi.Input[Union['HierarchyLevelArgs', 'HierarchyLevelArgsDict']]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'Hierarchy':
        """
