...
class DataForwardingRuleArgs:
    def __init__(__self__, *,
                 ...
                 payload_schema: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DataForwardingRule resource.
        :param pulumi.Input[builtins.str] destination_id: The data forwarding destination id.
        :param pulumi.Input[builtins.str] index_id: The *id* of the Partition or *index_id* of the Scheduled View the rule applies to.
        :param pulumi.Input[builtins.bool] enabled: True when the data forwarding rule is enabled. Will be treated as _false_ if left blank.
        :param pulumi.Input[builtins.str] file_format: Specify the path prefix to a directory in the S3 bucket and how to format the file name. For possible values, kindly refer the point 6 in the [documentation](https://help.sumologic.com/docs/manage/data-forwarding/amazon-s3-bucket/#forward-datato-s3).
        :param pulumi.Input[builtins.str] format: Format of the payload. Default format will be _csv_. 
               _text_ format should be used in conjunction with _raw_ payloadSchema and vice versa.
               
               The following attributes are exported:
        :param pulumi.Input[builtins.str] payload_schema: Schema for the payload. Default value of the payload schema is _allFields_ for scheduled view, and _builtInFields_ for partition.
    ...
    def payload_schema(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def payload_schema(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DataForwardingRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            format: Optional[pulumi.Input[builtins.str]] = None,
            index_id: Optional[pulumi.Input[builtins.str]] = None,
            payload_schema: Optional[pulumi.Input[builtins.str]] = None) -> 'DataForwardingRule':
        """
    ...
    @property
    @pulumi.getter(name="payloadSchema")
    def payload_schema(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Schema for the payload. Default value of the payload schema is _allFields_ for scheduled view, and _builtInFields_ for partition.
        _raw_ payloadSchema should be used in conjunction with _text_ format and vice versa.
        """
