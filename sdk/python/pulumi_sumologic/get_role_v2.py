...
class GetRoleV2Result:
    ...
    def audit_data_filter(self) -> builtins.str:
    ...
    def log_analytics_filter(self) -> builtins.str:
    ...
    def security_data_filter(self) -> builtins.str:
...
def get_role_v2(id: Optional[builtins.str] = None,
...
def get_role_v2_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
