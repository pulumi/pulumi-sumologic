...
class CseTagSchemaArgs:
    def __init__(__self__, *,
                 free_form: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input[builtins.bool] free_form: Whether the tag schema accepts free form custom values.
        :param pulumi.Input[builtins.str] key: Tag Schema key.
        :param pulumi.Input[builtins.str] label: Tag Schema label.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] content_types: Applicable content types. Valid values: "customInsight", "entity", "rule", "threatIntelligence".
        """
    ...
    def free_form(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @free_form.setter
    def free_form(self, value: pulumi.Input[builtins.bool]):
...
class _CseTagSchemaState:
    def __init__(__self__, *,
                 content_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 free_form: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="freeForm")
    def free_form(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the tag schema accepts free form custom values.
        """
        return pulumi.get(self, "free_form")
    ...
    @free_form.setter
    def free_form(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "free_form", value)
...
class CseTagSchema(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="contentTypes")
    def content_types(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Applicable content types. Valid values: "customInsight", "entity", "rule", "threatIntelligence".
        """
        return pulumi.get(self, "content_types")
    ...
    @property
    @pulumi.getter(name="freeForm")
    def free_form(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the tag schema accepts free form custom values.
        """
        return pulumi.get(self, "free_form")
