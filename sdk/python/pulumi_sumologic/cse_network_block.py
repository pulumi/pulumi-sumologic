...
class CseNetworkBlockArgs:
    def __init__(__self__, *,
                 address_block: pulumi.Input[builtins.str],
                 internal: Optional[pulumi.Input[builtins.bool]] = None,
                 label: Optional[pulumi.Input[builtins.str]] = None,
                 suppresses_signals: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a CseNetworkBlock resource.
        :param pulumi.Input[builtins.str] address_block: The address block.
        :param pulumi.Input[builtins.bool] internal: Internal flag.
        :param pulumi.Input[builtins.str] label: The displayable label of the address block.
        :param pulumi.Input[builtins.bool] suppresses_signals: Suppresses signal flag.
    ...
    def address_block(self) -> pulumi.Input[builtins.str]:
        """
        The address block.
        """
    ...
    def address_block(self, value: pulumi.Input[builtins.str]):
    ...
    def suppresses_signals(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def suppresses_signals(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _CseNetworkBlockState:
    def __init__(__self__, *,
                 address_block: Optional[pulumi.Input[builtins.str]] = None,
                 internal: Optional[pulumi.Input[builtins.bool]] = None,
                 label: Optional[pulumi.Input[builtins.str]] = None,
                 suppresses_signals: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    @property
    @pulumi.getter(name="addressBlock")
    def address_block(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The address block.
        """
        return pulumi.get(self, "address_block")
    ...
    @address_block.setter
    def address_block(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "address_block", value)
...
class CseNetworkBlock(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            internal: Optional[pulumi.Input[builtins.bool]] = None,
            label: Optional[pulumi.Input[builtins.str]] = None,
            suppresses_signals: Optional[pulumi.Input[builtins.bool]] = None) -> 'CseNetworkBlock':
        """
    ...
    @property
    @pulumi.getter(name="addressBlock")
    def address_block(self) -> pulumi.Output[builtins.str]:
        """
        The address block.
        """
        return pulumi.get(self, "address_block")
    ...
    @property
    @pulumi.getter(name="suppressesSignals")
    def suppresses_signals(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Suppresses signal flag.
