...
class _FieldState:
    def __init__(__self__, *,
                 data_type: Optional[pulumi.Input[builtins.str]] = None,
                 field_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @field_id.setter
    def field_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Field(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            field_id: Optional[pulumi.Input[builtins.str]] = None,
            field_name: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None) -> 'Field':
        """
    ...
    @property
    @pulumi.getter(name="fieldName")
    def field_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the field.
        """
        return pulumi.get(self, "field_name")
