...
class AwsInventorySource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            authentication = _utilities.configure(authentication, AwsInventorySourceAuthenticationArgs, True)
            ...
            path = _utilities.configure(path, AwsInventorySourcePathArgs, True)
