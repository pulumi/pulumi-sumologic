...
class AwsInventorySourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content_type: The content-type of the collected data. This has to be `AwsInventoryPath` for AWS Inventory source.
        ...
        :param pulumi.Input[builtins.int] scan_interval: Time interval in milliseconds of scans for new data. The minimum value is 1000 milliseconds. Currently this value is not respected.
        """
...
class AwsInventorySource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            timezone: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            use_autoline_matching: Optional[pulumi.Input[builtins.bool]] = None) -> 'AwsInventorySource':
        """
