...
class LocalFileSourceArgs:
    def __init__(__self__, *,
                 ...
                 path_expression: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] path_expression: A valid path expression (full path) of the file to collect. For files on Windows systems (not including Windows Events), enter the absolute path including the drive letter. Escape special characters and spaces with a backslash (). If you are collecting from Windows using CIFS/SMB, see Prerequisites for Windows Log Collection. Use a single asterisk wildcard [*] for file or folder names. Example:[var/foo/*.log]. Use two asterisks [**]to recurse within directories and subdirectories. Example: [var/*/.log].
        :param pulumi.Input[builtins.str] category: The default source category for the source.
        :param pulumi.Input[builtins.str] description: The description of the source.
        :param pulumi.Input[builtins.str] encoding: Defines the encoding form. Default is "UTF-8". Other supported encodings are listed [here](https://help.sumologic.com/docs/send-data/installed-collectors/sources/local-file-source/#supported-encoding-for-local-file-sources).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] fields: Map containing [key/value pairs][2].
        :param pulumi.Input[builtins.str] name: The name of the local file source. This is required, and has to be unique. Changing this will force recreation the source.
        """
    ...
    def path_expression(self) -> pulumi.Input[builtins.str]:
        """
        A valid path expression (full path) of the file to collect. For files on Windows systems (not including Windows Events), enter the absolute path including the drive letter. Escape special characters and spaces with a backslash (). If you are collecting from Windows using CIFS/SMB, see Prerequisites for Windows Log Collection. Use a single asterisk wildcard [*] for file or folder names. Example:[var/foo/*.log]. Use two asterisks [**]to recurse within directories and subdirectories. Example: [var/*/.log].
        """
    ...
    def path_expression(self, value: pulumi.Input[builtins.str]):
...
class _LocalFileSourceState:
    def __init__(__self__, *,
                 ...
                 multiline_processing_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 path_expression: Optional[pulumi.Input[builtins.str]] = None,
                 timezone: Optional[pulumi.Input[builtins.str]] = None,
                 use_autoline_matching: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    @property
    @pulumi.getter(name="pathExpression")
    def path_expression(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A valid path expression (full path) of the file to collect. For files on Windows systems (not including Windows Events), enter the absolute path including the drive letter. Escape special characters and spaces with a backslash (). If you are collecting from Windows using CIFS/SMB, see Prerequisites for Windows Log Collection. Use a single asterisk wildcard [*] for file or folder names. Example:[var/foo/*.log]. Use two asterisks [**]to recurse within directories and subdirectories. Example: [var/*/.log].
        """
        return pulumi.get(self, "path_expression")
    ...
    @path_expression.setter
    def path_expression(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "path_expression", value)
...
class LocalFileSource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cutoff_relative_time: Optional[pulumi.Input[builtins.str]] = None,
                 cutoff_timestamp: Optional[pulumi.Input[builtins.int]] = None,
                 default_date_formats: Optional[pulumi.Input[Sequence[pulumi.Input[Union['LocalFileSourceDefaultDateFormatArgs', 'LocalFileSourceDefaultDateFormatArgsDict']]]]] = None,
                 deny_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 encoding: Optional[pulumi.Input[builtins.str]] = None,
                 fields: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
    ...
    def get(resource_name: str,
            ...
            path_expression: Optional[pulumi.Input[builtins.str]] = None,
            timezone: Optional[pulumi.Input[builtins.str]] = None,
            use_autoline_matching: Optional[pulumi.Input[builtins.bool]] = None) -> 'LocalFileSource':
        """
    ...
    @property
    @pulumi.getter(name="denyLists")
    def deny_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "deny_lists")
    ...
    @property
    @pulumi.getter(name="pathExpression")
    def path_expression(self) -> pulumi.Output[builtins.str]:
        """
        A valid path expression (full path) of the file to collect. For files on Windows systems (not including Windows Events), enter the absolute path including the drive letter. Escape special characters and spaces with a backslash (). If you are collecting from Windows using CIFS/SMB, see Prerequisites for Windows Log Collection. Use a single asterisk wildcard [*] for file or folder names. Example:[var/foo/*.log]. Use two asterisks [**]to recurse within directories and subdirectories. Example: [var/*/.log].
        """
        return pulumi.get(self, "path_expression")
