...
class CseThresholdRuleArgs:
    def __init__(__self__, *,
                 ...
                 count_distinct: Optional[pulumi.Input[builtins.bool]] = None,
                 count_field: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The description of the generated Signals
        ...
        :param pulumi.Input[builtins.str] expression: The expression for which records to match on
        :param pulumi.Input[builtins.int] limit: A Signal will be fired when this many records/distinct field values are matched
        ...
        :param pulumi.Input[builtins.bool] count_distinct: Whether to count distinct values of a field, as opposed to just counting the number of records
        :param pulumi.Input[builtins.str] count_field: The field to count if `count_distinct` is set to true
        ...
        :param pulumi.Input[builtins.str] name: The name of the Rule and the generated Signals
    ...
    def count_distinct(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def count_distinct(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "count_distinct", value)

    @property
    @pulumi.getter(name="countField")
    def count_field(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @count_field.setter
    def count_field(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CseThresholdRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            window_size: Optional[pulumi.Input[builtins.str]] = None,
            window_size_millis: Optional[pulumi.Input[builtins.str]] = None) -> 'CseThresholdRule':
        """
    ...
    @property
    @pulumi.getter(name="countDistinct")
    def count_distinct(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to count distinct values of a field, as opposed to just counting the number of records
        """
        return pulumi.get(self, "count_distinct")
    ...
    @property
    @pulumi.getter(name="countField")
    def count_field(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The field to count if `count_distinct` is set to true
        """
        return pulumi.get(self, "count_field")
    ...
    @property
    @pulumi.getter
    def limit(self) -> pulumi.Output[builtins.int]:
        """
        A Signal will be fired when this many records/distinct field values are matched
        """
        return pulumi.get(self, "limit")
