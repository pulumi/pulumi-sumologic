...
def get_cse_log_mapping_vendor_product(guid: Optional[builtins.str] = None,
...
def get_cse_log_mapping_vendor_product_output(guid: Optional[pulumi.Input[Optional[builtins.str]]] = None,
