...
class _MetadataSourceState:
    def __init__(__self__, *,
        ...
        """
        _MetadataSourceState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            authentication=authentication,
            automatic_date_parsing=automatic_date_parsing,
            category=category,
...
class MetadataSource(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            MetadataSourceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if authentication is not None and not isinstance(authentication, MetadataSourceAuthenticationArgs):
                authentication = authentication or {}
                def _setter(key, value):
                    authentication[key] = value
                MetadataSourceAuthenticationArgs._configure(_setter, **authentication)
            ...
            if path is not None and not isinstance(path, MetadataSourcePathArgs):
                path = path or {}
                def _setter(key, value):
                    path[key] = value
                MetadataSourcePathArgs._configure(_setter, **path)
    ...
    def get(resource_name: str,
            ...
            timezone: Optional[pulumi.Input[str]] = None,
            url: Optional[pulumi.Input[str]] = None,
            use_autoline_matching: Optional[pulumi.Input[bool]] = None) -> 'MetadataSource':
        """
