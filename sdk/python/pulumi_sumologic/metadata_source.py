...
__all__ = ['MetadataSourceArgs', 'MetadataSource']

@pulumi.input_type
class MetadataSourceArgs:
    def __init__(__self__, *,
                 authentication: pulumi.Input['MetadataSourceAuthenticationArgs'],
                 collector_id: pulumi.Input[builtins.int],
                 content_type: pulumi.Input[builtins.str],
                 path: pulumi.Input['MetadataSourcePathArgs'],
                 ...
                 default_date_formats: Optional[pulumi.Input[Sequence[pulumi.Input['MetadataSourceDefaultDateFormatArgs']]]] = None,
        ...
        :param pulumi.Input[builtins.str] content_type: The content-type of the collected data. For Metadata source this is `AwsMetadata`. Details can be found in the [Sumologic documentation for hosted sources](https://help.sumologic.com/Send_Data/Sources/03Use_JSON_to_Configure_Sources/JSON_Parameters_for_Hosted_Sources).
    ...
    def authentication(self, value: pulumi.Input['MetadataSourceAuthenticationArgs']):
    ...
    @path.setter
    def path(self, value: pulumi.Input['MetadataSourcePathArgs']):
    ...
    def default_date_formats(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MetadataSourceDefaultDateFormatArgs']]]]:
        return pulumi.get(self, "default_date_formats")

    @default_date_formats.setter
    def default_date_formats(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['MetadataSourceDefaultDateFormatArgs']]]]):
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MetadataSourceFilterArgs']]]]:
        return pulumi.get(self, "filters")

    @filters.setter
    def filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['MetadataSourceFilterArgs']]]]):
...
@pulumi.input_type
class _MetadataSourceState:
    def __init__(__self__, *,
                 authentication: Optional[pulumi.Input['MetadataSourceAuthenticationArgs']] = None,
                 automatic_date_parsing: Optional[pulumi.Input[builtins.bool]] = None,
                 category: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 multiline_processing_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 path: Optional[pulumi.Input['MetadataSourcePathArgs']] = None,
    ...
    @authentication.setter
    def authentication(self, value: Optional[pulumi.Input['MetadataSourceAuthenticationArgs']]):
        pulumi.set(self, "authentication", value)
    ...
    @path.setter
    def path(self, value: Optional[pulumi.Input['MetadataSourcePathArgs']]):
        pulumi.set(self, "path", value)
...
class MetadataSource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param MetadataSourceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MetadataSourceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MetadataSourceArgs.__new__(MetadataSourceArgs)
        ...
        super(MetadataSource, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            timezone: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            use_autoline_matching: Optional[pulumi.Input[builtins.bool]] = None) -> 'MetadataSource':
        """
        ...
        __props__ = _MetadataSourceState.__new__(_MetadataSourceState)
        ...
        __props__.__dict__["use_autoline_matching"] = use_autoline_matching
        return MetadataSource(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="defaultDateFormats")
    def default_date_formats(self) -> pulumi.Output[Optional[Sequence['outputs.MetadataSourceDefaultDateFormat']]]:
        return pulumi.get(self, "default_date_formats")
    ...
    @property
    @pulumi.getter
    def filters(self) -> pulumi.Output[Optional[Sequence['outputs.MetadataSourceFilter']]]:
        return pulumi.get(self, "filters")
