...
class CloudwatchSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            authentication = _utilities.configure(authentication, CloudwatchSourceAuthenticationArgs, True)
            ...
            path = _utilities.configure(path, CloudwatchSourcePathArgs, True)
