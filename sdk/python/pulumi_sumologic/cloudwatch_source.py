...
__all__ = ['CloudwatchSourceArgs', 'CloudwatchSource']

@pulumi.input_type
class CloudwatchSourceArgs:
    def __init__(__self__, *,
                 authentication: pulumi.Input['CloudwatchSourceAuthenticationArgs'],
                 collector_id: pulumi.Input[builtins.int],
                 content_type: pulumi.Input[builtins.str],
                 path: pulumi.Input['CloudwatchSourcePathArgs'],
                 ...
                 default_date_formats: Optional[pulumi.Input[Sequence[pulumi.Input['CloudwatchSourceDefaultDateFormatArgs']]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 fields: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 filters: Optional[pulumi.Input[Sequence[pulumi.Input['CloudwatchSourceFilterArgs']]]] = None,
    ...
    def authentication(self, value: pulumi.Input['CloudwatchSourceAuthenticationArgs']):
    ...
    @path.setter
    def path(self, value: pulumi.Input['CloudwatchSourcePathArgs']):
    ...
    def default_date_formats(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CloudwatchSourceDefaultDateFormatArgs']]]]:
        return pulumi.get(self, "default_date_formats")

    @default_date_formats.setter
    def default_date_formats(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CloudwatchSourceDefaultDateFormatArgs']]]]):
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CloudwatchSourceFilterArgs']]]]:
        return pulumi.get(self, "filters")

    @filters.setter
    def filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CloudwatchSourceFilterArgs']]]]):
...
@pulumi.input_type
class _CloudwatchSourceState:
    def __init__(__self__, *,
                 authentication: Optional[pulumi.Input['CloudwatchSourceAuthenticationArgs']] = None,
                 automatic_date_parsing: Optional[pulumi.Input[builtins.bool]] = None,
                 category: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 multiline_processing_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 path: Optional[pulumi.Input['CloudwatchSourcePathArgs']] = None,
                 paused: Optional[pulumi.Input[builtins.bool]] = None,
                 scan_interval: Optional[pulumi.Input[builtins.int]] = None,
                 timezone: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @authentication.setter
    def authentication(self, value: Optional[pulumi.Input['CloudwatchSourceAuthenticationArgs']]):
        pulumi.set(self, "authentication", value)
    ...
    @path.setter
    def path(self, value: Optional[pulumi.Input['CloudwatchSourcePathArgs']]):
        pulumi.set(self, "path", value)
...
class CloudwatchSource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 authentication: Optional[pulumi.Input[Union['CloudwatchSourceAuthenticationArgs', 'CloudwatchSourceAuthenticationArgsDict']]] = None,
                 automatic_date_parsing: Optional[pulumi.Input[builtins.bool]] = None,
                 category: Optional[pulumi.Input[builtins.str]] = None,
                 collector_id: Optional[pulumi.Input[builtins.int]] = None,
                 content_type: Optional[pulumi.Input[builtins.str]] = None,
                 cutoff_relative_time: Optional[pulumi.Input[builtins.str]] = None,
                 cutoff_timestamp: Optional[pulumi.Input[builtins.int]] = None,
                 default_date_formats: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CloudwatchSourceDefaultDateFormatArgs', 'CloudwatchSourceDefaultDateFormatArgsDict']]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 fields: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 filters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CloudwatchSourceFilterArgs', 'CloudwatchSourceFilterArgsDict']]]]] = None,
                 force_timezone: Optional[pulumi.Input[builtins.bool]] = None,
                 hash_algorithm: Optional[pulumi.Input[builtins.str]] = None,
                 host_name: Optional[pulumi.Input[builtins.str]] = None,
                 manual_prefix_regexp: Optional[pulumi.Input[builtins.str]] = None,
                 multiline_processing_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 path: Optional[pulumi.Input[Union['CloudwatchSourcePathArgs', 'CloudwatchSourcePathArgsDict']]] = None,
                 paused: Optional[pulumi.Input[builtins.bool]] = None,
                 scan_interval: Optional[pulumi.Input[builtins.int]] = None,
                 timezone: Optional[pulumi.Input[builtins.str]] = None,
                 use_autoline_matching: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Union['CloudwatchSourceAuthenticationArgs', 'CloudwatchSourceAuthenticationArgsDict']] authentication: Authentication details for connecting to the S3 bucket.
        :param pulumi.Input[builtins.str] content_type: The content-type of the collected data. Details can be found in the [Sumologic documentation for hosted sources](https://help.sumologic.com/Send_Data/Sources/03Use_JSON_to_Configure_Sources/JSON_Parameters_for_Hosted_Sources).
        :param pulumi.Input[Union['CloudwatchSourcePathArgs', 'CloudwatchSourcePathArgsDict']] path: The location to scan for new data.
        :param pulumi.Input[builtins.bool] paused: When set to true, the scanner is paused. To disable, set to false.
        :param pulumi.Input[builtins.int] scan_interval: Time interval in milliseconds of scans for new data. The default is 300000 and the minimum value is 1000 milliseconds.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CloudwatchSourceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CloudwatchSourceArgs.__new__(CloudwatchSourceArgs)
        ...
        super(CloudwatchSource, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            timezone: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            use_autoline_matching: Optional[pulumi.Input[builtins.bool]] = None) -> 'CloudwatchSource':
        """
        ...
        __props__ = _CloudwatchSourceState.__new__(_CloudwatchSourceState)
        ...
        __props__.__dict__["use_autoline_matching"] = use_autoline_matching
        return CloudwatchSource(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="defaultDateFormats")
    def default_date_formats(self) -> pulumi.Output[Optional[Sequence['outputs.CloudwatchSourceDefaultDateFormat']]]:
        return pulumi.get(self, "default_date_formats")
    ...
    @property
    @pulumi.getter
    def filters(self) -> pulumi.Output[Optional[Sequence['outputs.CloudwatchSourceFilter']]]:
        return pulumi.get(self, "filters")
