...
class KinesisMetricsSourceArgs:
    def __init__(__self__, *,
                 ...
                 message_per_request: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def message_per_request(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "message_per_request")

    @message_per_request.setter
    def message_per_request(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _KinesisMetricsSourceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content_type: The content-type of the collected data. Details can be found in the [Sumologic documentation for hosted sources](https://help.sumologic.com/Send_Data/Sources/03Use_JSON_to_Configure_Sources/JSON_Parameters_for_Hosted_Sources).
        :param pulumi.Input['KinesisMetricsSourcePathArgs'] path: The location to scan for new data.
        :param pulumi.Input[builtins.str] url: The HTTP endpoint to used while creating Kinesis Firehose on AWS.
        """
...
class KinesisMetricsSource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 authentication: Optional[pulumi.Input[Union['KinesisMetricsSourceAuthenticationArgs', 'KinesisMetricsSourceAuthenticationArgsDict']]] = None,
                 automatic_date_parsing: Optional[pulumi.Input[builtins.bool]] = None,
                 category: Optional[pulumi.Input[builtins.str]] = None,
                 collector_id: Optional[pulumi.Input[builtins.int]] = None,
                 content_type: Optional[pulumi.Input[builtins.str]] = None,
                 cutoff_relative_time: Optional[pulumi.Input[builtins.str]] = None,
                 cutoff_timestamp: Optional[pulumi.Input[builtins.int]] = None,
                 default_date_formats: Optional[pulumi.Input[Sequence[pulumi.Input[Union['KinesisMetricsSourceDefaultDateFormatArgs', 'KinesisMetricsSourceDefaultDateFormatArgsDict']]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 fields: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 filters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['KinesisMetricsSourceFilterArgs', 'KinesisMetricsSourceFilterArgsDict']]]]] = None,
                 force_timezone: Optional[pulumi.Input[builtins.bool]] = None,
                 hash_algorithm: Optional[pulumi.Input[builtins.str]] = None,
                 host_name: Optional[pulumi.Input[builtins.str]] = None,
                 manual_prefix_regexp: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 multiline_processing_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 path: Optional[pulumi.Input[Union['KinesisMetricsSourcePathArgs', 'KinesisMetricsSourcePathArgsDict']]] = None,
                 timezone: Optional[pulumi.Input[builtins.str]] = None,
                 use_autoline_matching: Optional[pulumi.Input[builtins.bool]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['KinesisMetricsSourceAuthenticationArgs', 'KinesisMetricsSourceAuthenticationArgsDict']] authentication: Authentication details for connecting to the S3 bucket.
        :param pulumi.Input[builtins.str] content_type: The content-type of the collected data. Details can be found in the [Sumologic documentation for hosted sources](https://help.sumologic.com/Send_Data/Sources/03Use_JSON_to_Configure_Sources/JSON_Parameters_for_Hosted_Sources).
        :param pulumi.Input[Union['KinesisMetricsSourcePathArgs', 'KinesisMetricsSourcePathArgsDict']] path: The location to scan for new data.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            timezone: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            use_autoline_matching: Optional[pulumi.Input[builtins.bool]] = None) -> 'KinesisMetricsSource':
        """
    ...
    @property
    @pulumi.getter(name="messagePerRequest")
    def message_per_request(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "message_per_request")
