...
class CseAutomationArgs:
    def __init__(__self__, *,
                 cse_resource_type: pulumi.Input[builtins.str],
                 enabled: pulumi.Input[builtins.bool],
                 execution_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 playbook_id: pulumi.Input[builtins.str],
                 cse_resource_sub_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a CseAutomation resource.
        :param pulumi.Input[builtins.str] cse_resource_type: CSE Resource type for automation. Valid values: "INSIGHT", "ENTITY".
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] execution_types: Automation execution type. Valid values: "NEW_INSIGHT", "INSIGHT_CLOSED", "ON_DEMAND".
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cse_resource_sub_types: CSE Resource sub-type when cse_resource_type is specified as "ENTITY". Examples: "_ip", "_mac".
    ...
    def cse_resource_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cse_resource_type(self, value: pulumi.Input[builtins.str]):
    ...
    def execution_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def execution_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "execution_types", value)

    @property
    @pulumi.getter(name="playbookId")
    def playbook_id(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "playbook_id")

    @playbook_id.setter
    def playbook_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "playbook_id", value)

    @property
    @pulumi.getter(name="cseResourceSubTypes")
    def cse_resource_sub_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def cse_resource_sub_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _CseAutomationState:
    def __init__(__self__, *,
                 cse_resource_sub_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 cse_resource_type: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 execution_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 playbook_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cse_resource_sub_types: CSE Resource sub-type when cse_resource_type is specified as "ENTITY". Examples: "_ip", "_mac".
               ...
               The following attributes are exported:
        :param pulumi.Input[builtins.str] cse_resource_type: CSE Resource type for automation. Valid values: "INSIGHT", "ENTITY".
        :param pulumi.Input[builtins.str] description: Automation description.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] execution_types: Automation execution type. Valid values: "NEW_INSIGHT", "INSIGHT_CLOSED", "ON_DEMAND".
        :param pulumi.Input[builtins.str] name: Automation name.
        """
        if cse_resource_sub_types is not None:
            pulumi.set(__self__, "cse_resource_sub_types", cse_resource_sub_types)
    ...
    @property
    @pulumi.getter(name="cseResourceType")
    def cse_resource_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        CSE Resource type for automation. Valid values: "INSIGHT", "ENTITY".
        """
        return pulumi.get(self, "cse_resource_type")
    ...
    @cse_resource_type.setter
    def cse_resource_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cse_resource_type", value)
    ...
    @property
    @pulumi.getter(name="executionTypes")
    def execution_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Automation execution type. Valid values: "NEW_INSIGHT", "INSIGHT_CLOSED", "ON_DEMAND".
        """
        return pulumi.get(self, "execution_types")
    ...
    @execution_types.setter
    def execution_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "execution_types", value)
    ...
    @property
    @pulumi.getter(name="playbookId")
    def playbook_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "playbook_id")

    @playbook_id.setter
    def playbook_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "playbook_id", value)
...
class CseAutomation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            execution_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            playbook_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CseAutomation':
        """
    ...
    @property
    @pulumi.getter(name="cseResourceSubTypes")
    def cse_resource_sub_types(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        CSE Resource sub-type when cse_resource_type is specified as "ENTITY". Examples: "_ip", "_mac".
    ...
    @property
    @pulumi.getter(name="cseResourceType")
    def cse_resource_type(self) -> pulumi.Output[builtins.str]:
        """
        CSE Resource type for automation. Valid values: "INSIGHT", "ENTITY".
        """
        return pulumi.get(self, "cse_resource_type")
    ...
    @property
    @pulumi.getter(name="executionTypes")
    def execution_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Automation execution type. Valid values: "NEW_INSIGHT", "INSIGHT_CLOSED", "ON_DEMAND".
        """
        return pulumi.get(self, "execution_types")
    ...
    @property
    @pulumi.getter(name="playbookId")
    def playbook_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "playbook_id")
