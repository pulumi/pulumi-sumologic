...
class CloudToCloudSourceArgs:
    def __init__(__self__, *,
                 ...
                 schema_ref: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
        """
        The set of arguments for constructing a CloudToCloudSource resource.
        :param pulumi.Input[builtins.str] config: This is a JSON object which contains the configuration parameters for the Source. Each schema type requires different JSON parameters. Refer to `JSON Configuration` and `Config Parameters` sections in the integration page for the specific `type` you have chosen to create.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] schema_ref: Source schema details.
        """
    ...
    def schema_ref(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]:
        """
    ...
    @schema_ref.setter
    def schema_ref(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
...
class _CloudToCloudSourceState:
    def __init__(__self__, *,
                 ...
                 schema_ref: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="schemaRef")
    def schema_ref(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Source schema details.
        """
        return pulumi.get(self, "schema_ref")
    ...
    @schema_ref.setter
    def schema_ref(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "schema_ref", value)
...
class CloudToCloudSource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            collector_id: Optional[pulumi.Input[builtins.int]] = None,
            config: Optional[pulumi.Input[builtins.str]] = None,
            schema_ref: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'CloudToCloudSource':
        """
    ...
    @property
    @pulumi.getter(name="schemaRef")
    def schema_ref(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        Source schema details.
        """
        return pulumi.get(self, "schema_ref")
