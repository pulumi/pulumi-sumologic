...
class IngestBudgetV2Args:
    def __init__(__self__, *,
                 ...
                 capacity_bytes: pulumi.Input[builtins.int],
                 reset_time: pulumi.Input[builtins.str],
                 scope: pulumi.Input[builtins.str],
                 timezone: pulumi.Input[builtins.str],
                 audit_threshold: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] action: Action to take when ingest budget's capacity is reached. All actions are audited. Supported values are `stopCollecting` and `keepCollecting`.
        :param pulumi.Input[builtins.int] capacity_bytes: Capacity of the ingest budget, in bytes. It takes a few minutes for Collectors to stop collecting when capacity is reached. We recommend setting a soft limit that is lower than your needed hard limit. The capacity bytes unit varies based on the budgetType field. For `dailyVolume` budgetType the capacity specified is in bytes/day whereas for `minuteVolume` budgetType its bytes/min.
        :param pulumi.Input[builtins.str] reset_time: Reset time of the ingest budget in HH:MM format. Defaults to `00:00`
        :param pulumi.Input[builtins.str] scope: A scope is a constraint that will be used to identify the messages on which budget needs to be applied. A scope is consists of key and value separated by =. The field must be enabled in the fields table.
        :param pulumi.Input[builtins.str] timezone: The time zone to use for this collector. The value follows the [tzdata](https://en.wikipedia.org/wiki/Tz_database) naming convention. Defaults to `Etc/UTC`
        :param pulumi.Input[builtins.int] audit_threshold: The threshold as a percentage of when an ingest budget's capacity usage is logged in the Audit Index.
               
               The following attributes are exported:
        :param pulumi.Input[builtins.str] budget_type: The type of budget. Supported values are:  * `dailyVolume` * `minuteVolume`. Default value is `dailyVolume`.
        :param pulumi.Input[builtins.str] description: The description of the collector.
        :param pulumi.Input[builtins.str] name: Display name of the ingest budget. This must be unique across all of the ingest budgets
        """
    ...
    def capacity_bytes(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def capacity_bytes(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "capacity_bytes", value)

    @property
    @pulumi.getter(name="resetTime")
    def reset_time(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @reset_time.setter
    def reset_time(self, value: pulumi.Input[builtins.str]):
    ...
    def audit_threshold(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def audit_threshold(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _IngestBudgetV2State:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 reset_time: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="resetTime")
    def reset_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Reset time of the ingest budget in HH:MM format. Defaults to `00:00`
        """
        return pulumi.get(self, "reset_time")
    ...
    @reset_time.setter
    def reset_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "reset_time", value)
...
class IngestBudgetV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reset_time: Optional[pulumi.Input[builtins.str]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None,
            timezone: Optional[pulumi.Input[builtins.str]] = None) -> 'IngestBudgetV2':
        """
    ...
    @property
    @pulumi.getter(name="auditThreshold")
    def audit_threshold(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The threshold as a percentage of when an ingest budget's capacity usage is logged in the Audit Index.
    ...
    @property
    @pulumi.getter(name="budgetType")
    def budget_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of budget. Supported values are:  * `dailyVolume` * `minuteVolume`. Default value is `dailyVolume`.
        """
        return pulumi.get(self, "budget_type")
    ...
    @property
    @pulumi.getter(name="resetTime")
    def reset_time(self) -> pulumi.Output[builtins.str]:
        """
        Reset time of the ingest budget in HH:MM format. Defaults to `00:00`
        """
        return pulumi.get(self, "reset_time")
