...
class CloudfrontSourceArgs:
    def __init__(__self__, *,
        ...
        """
        CloudfrontSourceArgs._configure(
...
class _CloudfrontSourceState:
    def __init__(__self__, *,
        ...
        """
        _CloudfrontSourceState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            authentication=authentication,
            automatic_date_parsing=automatic_date_parsing,
            category=category,
...
class CloudfrontSource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 authentication: Optional[pulumi.Input[pulumi.InputType['CloudfrontSourceAuthenticationArgs']]] = None,
                 automatic_date_parsing: Optional[pulumi.Input[bool]] = None,
                 category: Optional[pulumi.Input[str]] = None,
                 collector_id: Optional[pulumi.Input[int]] = None,
                 content_type: Optional[pulumi.Input[str]] = None,
                 cutoff_relative_time: Optional[pulumi.Input[str]] = None,
                 cutoff_timestamp: Optional[pulumi.Input[int]] = None,
                 default_date_formats: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudfrontSourceDefaultDateFormatArgs']]]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 fields: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 filters: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CloudfrontSourceFilterArgs']]]]] = None,
                 force_timezone: Optional[pulumi.Input[bool]] = None,
                 host_name: Optional[pulumi.Input[str]] = None,
                 manual_prefix_regexp: Optional[pulumi.Input[str]] = None,
                 multiline_processing_enabled: Optional[pulumi.Input[bool]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 path: Optional[pulumi.Input[pulumi.InputType['CloudfrontSourcePathArgs']]] = None,
                 paused: Optional[pulumi.Input[bool]] = None,
                 scan_interval: Optional[pulumi.Input[int]] = None,
                 timezone: Optional[pulumi.Input[str]] = None,
                 use_autoline_matching: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['CloudfrontSourceAuthenticationArgs']] authentication: Authentication details for connecting to the S3 bucket.
        :param pulumi.Input[str] content_type: The content-type of the collected data. Details can be found in the [Sumologic documentation for hosted sources](https://help.sumologic.com/Send_Data/Sources/03Use_JSON_to_Configure_Sources/JSON_Parameters_for_Hosted_Sources).
        :param pulumi.Input[pulumi.InputType['CloudfrontSourcePathArgs']] path: The location to scan for new data.
        :param pulumi.Input[bool] paused: When set to true, the scanner is paused. To disable, set to false.
        :param pulumi.Input[int] scan_interval: Time interval in milliseconds of scans for new data. The default is 300000 and the minimum value is 1000 milliseconds.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            CloudfrontSourceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if authentication is not None and not isinstance(authentication, CloudfrontSourceAuthenticationArgs):
                authentication = authentication or {}
                def _setter(key, value):
                    authentication[key] = value
                CloudfrontSourceAuthenticationArgs._configure(_setter, **authentication)
            ...
            if path is not None and not isinstance(path, CloudfrontSourcePathArgs):
                path = path or {}
                def _setter(key, value):
                    path[key] = value
                CloudfrontSourcePathArgs._configure(_setter, **path)
    ...
    def get(resource_name: str,
            ...
            timezone: Optional[pulumi.Input[str]] = None,
            url: Optional[pulumi.Input[str]] = None,
            use_autoline_matching: Optional[pulumi.Input[bool]] = None) -> 'CloudfrontSource':
        """
